...
- Workbench routes keep the global sidebar visible so users can move between Computer, tasks, apps, approvals, memory, and thread history without losing context.
