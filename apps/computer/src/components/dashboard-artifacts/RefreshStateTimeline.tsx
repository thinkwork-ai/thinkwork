...
interface RefreshStateTimelineProps {
  state: RefreshState;
}
...
const STEPS = [
  {
    ...
    detail: "CRM, email, calendar, and web inputs",
  },
  {
    id: "transforms",
  ...
  },
  {
    ...
    detail: "Save a new private artifact version",
  },
] as const;

export function RefreshStateTimeline({ state }: RefreshStateTimelineProps) {
  return (
