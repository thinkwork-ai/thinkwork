...
const documents: Documents = {
  ...
  "\n  query CliCapabilityInspector(\n    $tenantId: ID!\n    $agentId: ID\n    $spaceId: ID\n    $agentProfileId: ID\n    $perspectiveUserId: ID\n  ) {\n    capabilityInspector(\n      tenantId: $tenantId\n      agentId: $agentId\n      spaceId: $spaceId\n      agentProfileId: $agentProfileId\n      perspectiveUserId: $perspectiveUserId\n    ) {\n      state\n      stateDetail\n      agentId\n      noUserBaseline\n      predicted {\n        computedAt\n        configFingerprint\n        items {\n          capabilityClass\n          capabilityId\n          displayName\n          active\n          provenance\n          reason\n          detail\n          tokenStatus\n        }\n      }\n    }\n  }\n":
    types.CliCapabilityInspectorDocument,
  "\n  query CliCostSummary($tenantId: ID!, $from: AWSDateTime, $to: AWSDateTime) {\n    costSummary(tenantId: $tenantId, from: $from, to: $to) {\n      totalUsd\n      llmUsd\n      computeUsd\n      toolsUsd\n      evalUsd\n      totalInputTokens\n      totalOutputTokens\n      eventCount\n    }\n  }\n":
    types.CliCostSummaryDocument,
  "\n  query CliCostByAgent($tenantId: ID!, $from: AWSDateTime, $to: AWSDateTime) {\n    costByAgent(tenantId: $tenantId, from: $from, to: $to) {\n      agentId\n      agentName\n      totalUsd\n      eventCount\n    }\n  }\n":
    types.CliCostByAgentDocument,
  "\n  query CliCostByUser($tenantId: ID!, $from: AWSDateTime, $to: AWSDateTime) {\n    costByUser(tenantId: $tenantId, from: $from, to: $to) {\n      userId\n      userName\n      userEmail\n      totalUsd\n      eventCount\n      isSystem\n    }\n  }\n":
    types.CliCostByUserDocument,
  "\n  query CliCostByModel($tenantId: ID!, $from: AWSDateTime, $to: AWSDateTime) {\n    costByModel(tenantId: $tenantId, from: $from, to: $to) {\n      model\n      totalUsd\n      inputTokens\n      outputTokens\n    }\n  }\n":
  ...
  "\n  mutation CliConnectKBSource($input: ConnectKnowledgeBaseSourceInput!) {\n    connectKnowledgeBaseSource(input: $input) {\n      id\n      kind\n      bucket\n      prefix\n      filterPatterns\n      accessStatus\n      sentinelDocumentKey\n    }\n  }\n":
    types.CliConnectKbSourceDocument,
  "\n  mutation CliCreateKB($input: CreateKnowledgeBaseInput!) {\n    createKnowledgeBase(input: $input) {\n      id\n      name\n      slug\n      status\n    }\n  }\n":
  ...
  "\n  mutation CliPromoteSpaceMemories(\n    $tenantId: ID\n    $spaceId: ID!\n    $memoryIds: [ID!]!\n    $justification: String!\n  ) {\n    promoteSpaceMemoriesToTenant(\n      tenantId: $tenantId\n      spaceId: $spaceId\n      memoryIds: $memoryIds\n      justification: $justification\n    ) {\n      promoted\n      alreadyPromoted\n      missing\n    }\n  }\n":
    types.CliPromoteSpaceMemoriesDocument,
  "\n  query CliTenantBankMemories($tenantId: ID, $limit: Int) {\n    tenantBankMemories(tenantId: $tenantId, limit: $limit) {\n      id\n      content\n      factType\n      sourceBankId\n      sourceMemoryId\n      sourceTimestamp\n      promotedBy\n      promotedAt\n      justification\n      accessCount\n      createdAt\n    }\n  }\n":
    types.CliTenantBankMemoriesDocument,
  "\n  query CliMemoryRecords($tenantId: ID, $assistantId: ID, $namespace: String!) {\n    memoryRecords(\n      tenantId: $tenantId\n      assistantId: $assistantId\n      namespace: $namespace\n    ) {\n      memoryRecordId\n      namespace\n      content {\n        text\n      }\n      strategy\n      createdAt\n      updatedAt\n    }\n  }\n":
