...
export type CliDashboardQuery = {
  __typename?: "Query";
  tenantAgent: { __typename?: "Agent"; id: string; status: AgentStatus };
  threads: Array<{
    __typename?: "Thread";
    id: string;
    status: ThreadStatus;
...
export type CliResendMemberInviteMutation = {
  __typename?: "Mutation";
  resendMemberInvite: {
    __typename?: "ResendMemberInviteResult";
    status: ResendMemberInviteStatus;
...
export type CliPromoteSpaceMemoriesMutation = {
  __typename?: "Mutation";
  promoteSpaceMemoriesToTenant: {
    __typename?: "TenantMemoryPromotionResult";
    promoted: Array<string>;
    alreadyPromoted: Array<string>;
...
export type CliTenantBankMemoriesQuery = {
  __typename?: "Query";
  tenantBankMemories: Array<{
    __typename?: "TenantBankMemory";
    id: string;
    content: string;
...
export type CliRebuildSkillCatalogIndexMutation = {
  __typename?: "Mutation";
  rebuildSkillCatalogIndex: Array<{
    __typename?: "SkillCatalogRebuildResult";
    tenantId: string;
    tenantSlug: string;
    skillsInS3: number;
...
>;
export const CliResendMemberInviteDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CliResendMemberInvite" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ResendMemberInviteInput" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "resendMemberInvite" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "tenantId" },
...
>;
export const CliPromoteSpaceMemoriesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CliPromoteSpaceMemories" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "memoryIds" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "justification" },
          },
          type: {
            kind: "NonNullType",
            type: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "promoteSpaceMemoriesToTenant" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "tenantId" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "alreadyPromoted" },
                },
  ...
  CliPromoteSpaceMemoriesMutation,
  CliPromoteSpaceMemoriesMutationVariables
>;
export const CliTenantBankMemoriesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CliTenantBankMemories" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "tenantBankMemories" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "tenantId" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "sourceMemoryId" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "sourceTimestamp" },
                },
                { kind: "Field", name: { kind: "Name", value: "promotedBy" } },
                { kind: "Field", name: { kind: "Name", value: "promotedAt" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "justification" },
                },
  ...
  CliTenantBankMemoriesQuery,
  CliTenantBankMemoriesQueryVariables
>;
...
>;
export const CliRebuildSkillCatalogIndexDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CliRebuildSkillCatalogIndex" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "skillsInS3" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "rowsUpserted" },
                },
                { kind: "Field", name: { kind: "Name", value: "rowsSkipped" } },
                { kind: "Field", name: { kind: "Name", value: "rowsDeleted" } },
  ...
  CliRebuildSkillCatalogIndexMutation,
  CliRebuildSkillCatalogIndexMutationVariables
>;
