...
export default function EditRoutineScreen() {
  ...
  // chat agent has prior intent in context. The edit flow targets the ASL
  // chat builder; the routine's documentation markdown is regenerated by
  // publishRoutineVersion on every publish.
  ...
  // Resolve a chat-capable agent for the routine builder
