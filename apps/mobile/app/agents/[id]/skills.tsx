...
export default function AgentSkillsScreen() {
  ...
  const skillItem = configSkillId
    ? items.find((s) => s.skillId === configSkillId)
    : null;
  ...
  const handleAddSkill = async (slug: string) => {
    ...
    try {
      ...
      const newItems = [
        ...items,
        { skillId: slug, enabled: true, config: initialConfig },
      ];
      setItems(newItems);
            ...
            {!agent ? (
              ...
              <View className="flex-1 items-center justify-center p-8 mt-12">
                ...
                <Muted className="text-center mt-4 text-base leading-6">
                  No skills installed.{"\n"}Tap Add to expand your agent's
                  capabilities.
                </Muted>
              </View>
            ) : (
                ...
                >
                  ...
                  {addingSlug === skill.slug ? (
                    ...
                    <View
                      ...
                      style={{ backgroundColor: colors.primary, minWidth: 72 }}
                    >
              ...
              <>
                {envFields.map((field) => (
                  <View key={field} className="mb-4">
                    ...
                    <TextInput
                      ...
                      onChangeText={(text) =>
                        setEnvValues((prev) => ({ ...prev, [field]: text }))
                      }
                      secureTextEntry={
                ...
                {!isOAuthSkill && envFields.length > 0 && (
                  <Pressable
                    ...
                    disabled={
                      savingCreds ||
                      envFields.some((f) => !envValues[f]?.trim())
                    }
