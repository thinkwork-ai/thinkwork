...
const WEB_WRAP_STYLE =
  Platform.OS === "web" ? ({ wordBreak: "break-word" } as any) : undefined;
...
export function TimelineNode({
  ...
  const iconNudgeStyle =
    isSynthetic && isFirst ? { marginTop: 5 } : { marginTop: 2.5 };
    ...
    <View className="flex-row">
      <View className="items-center" style={{ width: 18 }}>
        {!isFirst && (
          <View
            className="w-0.5"
            style={{ height: topConnectorHeight, backgroundColor: lineColor }}
          />
        )}
