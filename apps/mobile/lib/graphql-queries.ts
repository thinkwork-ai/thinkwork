...
export const ActivationSessionQuery = gql`
...
export const SubmitActivationTurnMutation = gql`
...
export const CheckpointActivationLayerMutation = gql`
...
export const ApplyActivationBundleMutation = gql`
...
export const DismissActivationRecommendationMutation = gql`
  mutation DismissActivationRecommendation(
