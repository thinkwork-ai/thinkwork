...
const documents: Documents = {
  ...
  "\n  query Agent($tenantId: ID!) {\n    agent: tenantAgent(tenantId: $tenantId) {\n      id\n      tenantId\n      name\n      slug\n      role\n      type\n      status\n      systemPrompt\n      adapterType\n      adapterConfig\n      runtimeConfig\n      lastHeartbeatAt\n      avatarUrl\n      reportsToId\n      humanPairId\n      version\n      capabilities {\n        id\n        capability\n        config\n        enabled\n      }\n      budgetPolicy {\n        id\n        period\n        limitUsd\n        actionOnExceed\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.AgentDocument,
  "\n  query MyApprovedModelCatalog {\n    myApprovedModelCatalog {\n      id\n      modelId\n      displayName\n      provider\n    }\n  }\n":
    types.MyApprovedModelCatalogDocument,
  "\n  mutation CreateAgent($tenantId: ID!, $input: UpdateTenantAgentInput!) {\n    updateTenantAgent(tenantId: $tenantId, input: $input) {\n      id\n      tenantId\n      name\n      type\n      status\n      createdAt\n    }\n  }\n":
  ...
  "\n  query WorkItems($input: WorkItemsInput) {\n    workItems(input: $input) {\n      id\n      tenantId\n      spaceId\n      statusId\n      status {\n        id\n        name\n        color\n        category\n        isActive\n        isFinal\n        displayOrder\n      }\n      title\n      notes\n      priority\n      ownerUserId\n      dueAt\n      required\n      applicable\n      blocked\n      threadLinks {\n        id\n        threadId\n        relationship\n        createdAt\n      }\n      events {\n        id\n        eventType\n        previousStatusId\n        newStatusId\n        createdAt\n      }\n      comments {\n        id\n        authorUserId\n        authorAgentId\n        body\n        createdAt\n        updatedAt\n      }\n      createdAt\n      updatedAt\n      archivedAt\n    }\n  }\n":
    types.WorkItemsDocument,
  "\n  query WorkItem($tenantId: ID, $id: ID!) {\n    workItem(tenantId: $tenantId, id: $id) {\n      id\n      tenantId\n      spaceId\n      statusId\n      status {\n        id\n        name\n        color\n        category\n        isActive\n        isFinal\n        displayOrder\n      }\n      title\n      notes\n      priority\n      ownerUserId\n      dueAt\n      required\n      applicable\n      blocked\n      threadLinks {\n        id\n        threadId\n        relationship\n        createdAt\n      }\n      events {\n        id\n        eventType\n        previousStatusId\n        newStatusId\n        createdAt\n      }\n      comments {\n        id\n        authorUserId\n        authorAgentId\n        body\n        createdAt\n        updatedAt\n      }\n      createdAt\n      updatedAt\n      archivedAt\n    }\n  }\n":
    types.WorkItemDocument,
  "\n  query WorkItemStatuses($tenantId: ID, $spaceId: ID!) {\n    workItemStatuses(tenantId: $tenantId, spaceId: $spaceId) {\n      id\n      tenantId\n      spaceId\n      name\n      color\n      category\n      isActive\n      isFinal\n      isDefault\n      displayOrder\n    }\n  }\n":
    types.WorkItemStatusesDocument,
  "\n  query SpacesWithMembers($tenantId: ID!) {\n    spaces(tenantId: $tenantId) {\n      id\n      name\n      members {\n        id\n        userId\n        role\n        user {\n          id\n          name\n          email\n          image\n        }\n      }\n    }\n  }\n":
    types.SpacesWithMembersDocument,
  "\n  mutation UpdateWorkItemStatus($input: UpdateWorkItemStatusInput!) {\n    updateWorkItemStatus(input: $input) {\n      id\n      statusId\n      status {\n        id\n        name\n        category\n        color\n        displayOrder\n      }\n      blocked\n      updatedAt\n    }\n  }\n":
    types.UpdateWorkItemStatusDocument,
  "\n  mutation UpdateWorkItem($input: UpdateWorkItemInput!) {\n    updateWorkItem(input: $input) {\n      id\n      ownerUserId\n      updatedAt\n    }\n  }\n":
    types.UpdateWorkItemDocument,
  "\n  mutation CreateWorkItemComment($input: CreateWorkItemCommentInput!) {\n    createWorkItemComment(input: $input) {\n      id\n      workItemId\n      authorUserId\n      authorAgentId\n      body\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.CreateWorkItemCommentDocument,
  "\n  query MySlackLinks($tenantId: ID!) {\n    mySlackLinks(tenantId: $tenantId) {\n      id\n      tenantId\n      slackTeamId\n      slackTeamName\n      slackUserId\n      slackUserName\n      slackUserEmail\n      userId\n      status\n      linkedAt\n      unlinkedAt\n    }\n  }\n":
  ...
  "\n  query MobileRoutineExecutionsList(\n    $routineId: ID!\n    $status: RoutineExecutionStatus\n    $limit: Int\n    $cursor: String\n  ) {\n    routineExecutions(\n      routineId: $routineId\n      status: $status\n      limit: $limit\n      cursor: $cursor\n    ) {\n      id\n      status\n      triggerSource\n      startedAt\n      finishedAt\n      totalLlmCostUsdCents\n      errorCode\n      createdAt\n    }\n  }\n":
    types.MobileRoutineExecutionsListDocument,
  "\n  query MobileRoutineExecutionDetail($id: ID!) {\n    routineExecution(id: $id) {\n      id\n      tenantId\n      routineId\n      sfnExecutionArn\n      triggerSource\n      inputJson\n      outputJson\n      status\n      startedAt\n      finishedAt\n      errorCode\n      errorMessage\n      totalLlmCostUsdCents\n      stepEvents {\n        id\n        nodeId\n        recipeType\n        status\n        startedAt\n        finishedAt\n        inputJson\n        outputJson\n        errorJson\n        llmCostUsdCents\n        retryCount\n        stdoutS3Uri\n        stderrS3Uri\n        stdoutPreview\n        truncated\n        createdAt\n      }\n      routine {\n        id\n        name\n        description\n        currentVersion\n        documentationMd\n      }\n      aslVersion {\n        id\n        versionNumber\n        markdownSummary\n        stepManifestJson\n      }\n      createdAt\n    }\n  }\n":
    types.MobileRoutineExecutionDetailDocument,
  "\n  mutation CreateRoutine($input: CreateRoutineInput!) {\n    createRoutine(input: $input) {\n      id\n      tenantId\n      name\n      type\n      status\n      createdAt\n    }\n  }\n":
  ...
  "\n  query NewThreadMentionTargets($tenantId: ID!) {\n    tenantMentionTargets(tenantId: $tenantId) {\n      id\n      targetType\n      targetId\n      displayName\n      aliases\n      isDefaultAgent\n      avatarUrl\n      role\n      email\n      description\n    }\n  }\n":
    types.NewThreadMentionTargetsDocument,
  "\n  query ThreadMentionTargets($threadId: ID!) {\n    threadMentionTargets(threadId: $threadId) {\n      id\n      targetType\n      targetId\n      displayName\n      aliases\n      isDefaultAgent\n      avatarUrl\n      role\n      email\n      description\n    }\n  }\n":
    types.ThreadMentionTargetsDocument,
  "\n  query Thread($id: ID!) {\n    thread(id: $id) {\n      id\n      tenantId\n      agentId\n      spaceId\n      space {\n        id\n        name\n        slug\n      }\n      number\n      identifier\n      title\n      status\n      lifecycleStatus\n      channel\n      assigneeType\n      assigneeId\n      reporterId\n      labels\n      metadata\n      dueAt\n      closedAt\n      messages(limit: 100) {\n        edges {\n          node {\n            id\n            role\n            content\n            senderType\n            senderId\n            sender {\n              type\n              id\n              displayName\n              avatarUrl\n            }\n            createdAt\n            durableArtifact {\n              id\n              title\n              type\n              status\n            }\n          }\n        }\n      }\n      attachments {\n        id\n        name\n        mimeType\n        sizeBytes\n        createdAt\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
  ...
  "\n  query ComputerApprovals($tenantId: ID!) {\n    inboxItems(tenantId: $tenantId, status: PENDING) {\n      id\n      tenantId\n      type\n      status\n      title\n      description\n      entityType\n      entityId\n      config\n      expiresAt\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ComputerApprovalsDocument,
  "\n  query ComputerApproval($id: ID!) {\n    inboxItem(id: $id) {\n      id\n      tenantId\n      type\n      status\n      title\n      description\n      entityType\n      entityId\n      config\n      expiresAt\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ComputerApprovalDocument,
  "\n  mutation ApproveComputerApproval($id: ID!, $input: ApproveInboxItemInput) {\n    approveInboxItem(id: $id, input: $input) {\n      id\n      tenantId\n      type\n      status\n      title\n      description\n      entityType\n      entityId\n      config\n      expiresAt\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ApproveComputerApprovalDocument,
  "\n  mutation RejectComputerApproval($id: ID!, $input: RejectInboxItemInput) {\n    rejectInboxItem(id: $id, input: $input) {\n      id\n      tenantId\n      type\n      status\n      title\n      description\n      entityType\n      entityId\n      config\n      expiresAt\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.RejectComputerApprovalDocument,
  "\n  mutation DecideInboxItem($id: ID!, $input: InboxItemDecisionInput!) {\n    decideInboxItem(id: $id, input: $input) {\n      id\n      status\n      reviewNotes\n      decidedBy\n      decidedAt\n      updatedAt\n    }\n  }\n":
  ...
  "\n  query WikiPageSourceMemoryIds(\n    $tenantId: ID!\n    $userId: ID\n    $type: WikiPageType!\n    $slug: String!\n    $limit: Int\n  ) {\n    wikiPage(tenantId: $tenantId, userId: $userId, type: $type, slug: $slug) {\n      id\n      sourceMemoryIds(limit: $limit)\n    }\n  }\n":
    types.WikiPageSourceMemoryIdsDocument,
  "\n  query MemoryRecordsByIds($tenantId: ID!, $ids: [ID!]!) {\n    memoryRecordsByIds(tenantId: $tenantId, ids: $ids) {\n      memoryRecordId\n      content {\n        text\n      }\n      createdAt\n      updatedAt\n      factType\n      strategyId\n    }\n  }\n":
    types.MemoryRecordsByIdsDocument,
  "\n  mutation DeleteMemoryRecord($userId: ID!, $memoryRecordId: ID!) {\n    deleteMemoryRecord(userId: $userId, memoryRecordId: $memoryRecordId)\n  }\n":
