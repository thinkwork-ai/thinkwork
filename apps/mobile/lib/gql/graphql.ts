...
export type AgentWorkspaceReviewsQuery = { __typename?: 'Query', agentWorkspaceReviews: Array<{ __typename?: 'AgentWorkspaceReview', threadId?: string | null, reviewObjectKey?: string | null, targetPath: string, requestedAt: any, reason?: string | null, payload?: any | null, reviewEtag?: string | null, run: { __typename?: 'AgentWorkspaceRun', id: string, agentId: string, targetPath: string, status: string, currentWakeupRequestId?: string | null, currentThreadTurnId?: string | null, lastEventAt: any, createdAt: any, updatedAt: any }, latestEvent?: { __typename?: 'AgentWorkspaceEvent', id: string, eventType: string, reason?: string | null, sourceObjectKey: string, payload?: any | null, createdAt: any } | null }> };
...
export type AgentWorkspaceReviewQuery = { __typename?: 'Query', agentWorkspaceReview?: { __typename?: 'AgentWorkspaceReview', threadId?: string | null, reviewObjectKey?: string | null, targetPath: string, requestedAt: any, reason?: string | null, payload?: any | null, reviewBody?: string | null, reviewEtag?: string | null, reviewMissing?: boolean | null, proposedChanges: Array<{ __typename?: 'AgentWorkspaceProposedChange', path?: string | null, kind: string, summary: string, diff?: string | null, before?: string | null, after?: string | null }>, run: { __typename?: 'AgentWorkspaceRun', id: string, tenantId: string, agentId: string, targetPath: string, status: string, currentWakeupRequestId?: string | null, currentThreadTurnId?: string | null, lastEventAt: any, createdAt: any, updatedAt: any }, events: Array<{ __typename?: 'AgentWorkspaceEvent', id: string, eventType: string, reason?: string | null, sourceObjectKey: string, payload?: any | null, createdAt: any }>, decisionEvents: Array<{ __typename?: 'AgentWorkspaceEvent', id: string, eventType: string, reason?: string | null, actorType?: string | null, actorId?: string | null, payload?: any | null, createdAt: any }> } | null };
...
export const AgentWorkspaceReviewsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AgentWorkspaceReviews"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tenantId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"agentId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"agentWorkspaceReviews"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tenantId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tenantId"}}},{"kind":"Argument","name":{"kind":"Name","value":"agentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"agentId"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"threadId"}},{"kind":"Field","name":{"kind":"Name","value":"reviewObjectKey"}},{"kind":"Field","name":{"kind":"Name","value":"targetPath"}},{"kind":"Field","name":{"kind":"Name","value":"requestedAt"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"payload"}},{"kind":"Field","name":{"kind":"Name","value":"reviewEtag"}},{"kind":"Field","name":{"kind":"Name","value":"run"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"agentId"}},{"kind":"Field","name":{"kind":"Name","value":"targetPath"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"currentWakeupRequestId"}},{"kind":"Field","name":{"kind":"Name","value":"currentThreadTurnId"}},{"kind":"Field","name":{"kind":"Name","value":"lastEventAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"latestEvent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"eventType"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"sourceObjectKey"}},{"kind":"Field","name":{"kind":"Name","value":"payload"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}}]}}]} as unknown as DocumentNode<AgentWorkspaceReviewsQuery, AgentWorkspaceReviewsQueryVariables>;
