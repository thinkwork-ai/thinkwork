...
export type MyComputerQuery = { __typename?: 'Query', myComputer?: { __typename?: 'Computer', id: string, name: string, slug: string, status: ComputerStatus, runtimeStatus: ComputerRuntimeStatus } | null };
