...
export type AddTeamAgentMutation = {
  __typename?: "Mutation";
  addTeamAgent: {
    __typename?: "TeamAgent";
    id: string;
...
export type RemoveTeamAgentMutation = {
  __typename?: "Mutation";
...
export type RemoveTeamUserMutation = {
  __typename?: "Mutation";
...
export type ActivationSessionQuery = {
  ...
  activationSession?: {
    ...
    tenantId: string;
    mode: ActivationMode;
    focusLayer?: ActivationLayer | null;
    currentLayer: ActivationLayer;
    status: ActivationStatus;
    layerStates: any;
...
export type GenerateActivationAutomationCandidatesMutation = {
  __typename?: "Mutation";
  generateActivationAutomationCandidates: Array<{
    __typename?: "ActivationAutomationCandidate";
    id: string;
    title: string;
    summary: string;
...
export type StartActivationMutation = {
  __typename?: "Mutation";
  startActivation: {
    __typename?: "ActivationSession";
    id: string;
...
export type SubmitActivationTurnMutation = {
  __typename?: "Mutation";
...
export type CheckpointActivationLayerMutation = {
  __typename?: "Mutation";
...
export type ApplyActivationBundleMutation = {
  __typename?: "Mutation";
...
export type DismissActivationRecommendationMutation = {
  __typename?: "Mutation";
...
export const AddTeamAgentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  AddTeamAgentMutation,
  AddTeamAgentMutationVariables
>;
export const RemoveTeamAgentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  RemoveTeamAgentMutation,
  RemoveTeamAgentMutationVariables
>;
export const AddTeamUserDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<AddTeamUserMutation, AddTeamUserMutationVariables>;
export const RemoveTeamUserDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
export const RoutineRunsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<RoutineRunsQuery, RoutineRunsQueryVariables>;
export const RoutineRunDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "RoutineRunDetail" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
                ...
                { kind: "Field", name: { kind: "Name", value: "metadata" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "stepIndex" },
                      },
                      { kind: "Field", name: { kind: "Name", value: "name" } },
                      {
                        kind: "Field",
  ...
  RoutineRunDetailQuery,
  RoutineRunDetailQueryVariables
>;
...
>;
export const ActivationSessionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ActivationSession" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "focusLayer" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "currentLayer" },
                },
                { kind: "Field", name: { kind: "Name", value: "status" } },
                { kind: "Field", name: { kind: "Name", value: "layerStates" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "lastAgentMessage" },
                },
                { kind: "Field", name: { kind: "Name", value: "updatedAt" } },
              ],
            },
  ...
  ActivationSessionQueryVariables
>;
export const GenerateActivationAutomationCandidatesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "GenerateActivationAutomationCandidates" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            name: {
              kind: "Name",
              value: "generateActivationAutomationCandidates",
            },
            arguments: [
              {
                kind: "Argument",
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "whySuggested" },
                },
                {
                  kind: "Field",
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "costEstimate" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "disclosureVersion" },
                },
              ],
            },
          },
...
>;
export const StartActivationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "StartActivation" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "StartActivationInput" },
            },
          },
        },
      ],
  ...
  StartActivationMutation,
  StartActivationMutationVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "SubmitActivationTurn" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "SubmitActivationTurnInput" },
            },
          },
        },
      ],
...
>;
export const CheckpointActivationLayerDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CheckpointActivationLayer" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CheckpointActivationLayerInput" },
            },
          },
        },
      ],
  ...
  CheckpointActivationLayerMutationVariables
>;
export const ApplyActivationBundleDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ApplyActivationBundleInput" },
            },
          },
        },
      ],
  ...
  ApplyActivationBundleMutationVariables
>;
export const DismissActivationRecommendationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DismissActivationRecommendation" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: "Name",
                value: "DismissActivationRecommendationInput",
              },
            },
          },
        },
  ...
  DismissActivationRecommendationMutation,
