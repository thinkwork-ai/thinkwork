...
export type DocumentArtifactRenderQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type DocumentArtifactRenderQuery = { __typename?: 'Query', artifact?: { __typename?: 'Artifact', id: string, renderHtml?: string | null } | null };
...
export const DocumentArtifactRenderDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DocumentArtifactRender"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifact"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"renderHtml"}}]}}]}}]} as unknown as DocumentNode<DocumentArtifactRenderQuery, DocumentArtifactRenderQueryVariables>;
