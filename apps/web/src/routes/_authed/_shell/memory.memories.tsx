...
export const Route = createFileRoute("/_authed/_shell/memory/memories")({
  component: MemoriesPage,
  validateSearch: (search: Record<string, unknown>): { view?: MemoryView } => ({
...
function MemoriesPage() {
  ...
  const activeTab =
    ...
    "";
  const view: MemoryView = viewParam ?? "table";
