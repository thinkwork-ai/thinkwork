...
export type RoutineProposalsQuery = { __typename?: 'Query', routineProposals: Array<{ __typename?: 'CapabilityRoutineProposal', id: string, tenantId: string, routineId?: string | null, payloadFingerprint: string, status: string, approvalMode?: string | null, inboxItemId?: string | null, createdByActorType?: string | null, decidedAt?: any | null, promotedCommitSha?: string | null, createdAt: any }> };
