...
export type SettingsStartDeploymentReleaseUpdateMutation = { __typename?: 'Mutation', startDeploymentReleaseUpdate: { __typename?: 'DeploymentReleaseUpdate', executionArn?: string | null, stateMachineArn: string, evidenceBucket?: string | null, evidencePrefix: string, message: string, release: { __typename?: 'DeploymentRelease', version: string, manifestUrl: string, manifestSha256: string, signed: boolean, deployable: boolean } } };
...
export type SettingsBudgetStatusQuery = { __typename?: 'Query', budgetStatus: Array<{ __typename?: 'BudgetStatus', spentUsd: number, remainingUsd: number, percentUsed: number, status: string, policy: { __typename?: 'BudgetPolicy', id: string, tenantId: string, userId?: string | null, scope: string, period: string, limitUsd: number, actionOnExceed: string, enabled: boolean } }> };
...
export type SettingsWebhookQuery = { __typename?: 'Query', webhook?: { __typename?: 'Webhook', id: string, name: string, description?: string | null, token: string, targetType: string, prompt?: string | null, enabled: boolean, rateLimit?: number | null, invocationCount: number, lastInvokedAt?: any | null, createdAt: any } | null };
...
export type SettingsWebhookDeliveriesQuery = { __typename?: 'Query', webhookDeliveries: Array<{ __typename?: 'WebhookDelivery', id: string, receivedAt: any, providerName?: string | null, normalizedKind?: string | null, signatureStatus: string, resolutionStatus: string, statusCode?: number | null, threadCreated?: boolean | null }> };
...
export type SettingsUpdateWebhookMutation = { __typename?: 'Mutation', updateWebhook: { __typename?: 'Webhook', id: string, name: string, description?: string | null, prompt?: string | null, enabled: boolean, rateLimit?: number | null } };
...
export type SettingsPluginCatalogQuery = { __typename?: 'Query', pluginCatalog: Array<{ __typename?: 'PluginCatalogEntry', pluginKey: string, displayName: string, description: string, latestVersion: string, updateAvailable: boolean, versions: Array<{ __typename?: 'PluginCatalogVersion', version: string, payloadSha256: string, requiredOauthScopes: Array<string>, components: Array<{ __typename?: 'PluginCatalogComponent', key: string, type: string, displayName?: string | null }> }>, install?: { __typename?: 'PluginInstall', id: string, pluginKey: string, pinnedVersion: string, state: string, lastTransitionAt: any, lastError?: string | null, activatedUserCount: number, components: Array<{ __typename?: 'PluginComponent', id: string, componentKey: string, componentType: string, state: string, lastError?: string | null }> } | null }> };

export type SettingsPluginInstallsQueryVariables = Exact<{ [key: string]: never; }>;


export type SettingsPluginInstallsQuery = { __typename?: 'Query', pluginInstalls: Array<{ __typename?: 'PluginInstall', id: string, pluginKey: string, pinnedVersion: string, state: string, lastTransitionAt: any, lastError?: string | null, activatedUserCount: number, components: Array<{ __typename?: 'PluginComponent', id: string, componentKey: string, componentType: string, state: string, lastError?: string | null }> }> };
...
export const SettingsCostByUserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SettingsCostByUser"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tenantId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"costByUser"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tenantId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tenantId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"userName"}},{"kind":"Field","name":{"kind":"Name","value":"userEmail"}},{"kind":"Field","name":{"kind":"Name","value":"totalUsd"}},{"kind":"Field","name":{"kind":"Name","value":"eventCount"}},{"kind":"Field","name":{"kind":"Name","value":"isSystem"}}]}}]}}]} as unknown as DocumentNode<SettingsCostByUserQuery, SettingsCostByUserQueryVariables>;
