...
export type EvalProfilesQuery = { __typename?: 'Query', evalProfiles: Array<{ __typename?: 'EvalProfile', id: string, name: string, model: string, runtimeType: string, judgeModel?: string | null, trials: number, isDefault: boolean, archivedAt?: any | null, createdAt: any, updatedAt: any }> };
...
export type CreateEvalProfileMutation = { __typename?: 'Mutation', createEvalProfile: { __typename?: 'EvalProfile', id: string, name: string, model: string, runtimeType: string, judgeModel?: string | null, trials: number, isDefault: boolean } };
...
export type UpdateEvalProfileMutation = { __typename?: 'Mutation', updateEvalProfile: { __typename?: 'EvalProfile', id: string, name: string, model: string, runtimeType: string, judgeModel?: string | null, trials: number, isDefault: boolean } };
...
export type SettingsUpdateTenantBrandingMutationVariables = Exact<{
  tenantId: Scalars['ID']['input'];
  input: UpdateTenantSettingsInput;
}>;


export type SettingsUpdateTenantBrandingMutation = { __typename?: 'Mutation', updateTenantSettings: { __typename?: 'TenantSettings', id: string, features?: any | null, updatedAt: any } };
...
export type SettingsCanonicalEntitiesQuery = { __typename?: 'Query', canonicalEntities: Array<{ __typename?: 'CanonicalEntity', id: string, entityTypeSlug: string, displayName: string, normalizedName: string, status: string, mergedIntoId?: string | null, version: number, updatedAt?: any | null, sourceMappings: Array<{ __typename?: 'EntitySourceMapping', id: string, sourceSystem: string, namespace: string, externalId: string, visibility: string, createdBy: string, createdByUserId?: string | null, createdThreadRef?: string | null, createdAt?: any | null }> }> };
...
export type SettingsAuthorEntitySourceMappingMutation = { __typename?: 'Mutation', authorEntitySourceMapping: { __typename?: 'AuthorEntitySourceMappingResult', status: string, reason?: string | null, existingMappingId?: string | null, existingCanonicalEntityId?: string | null, mapping?: { __typename?: 'EntitySourceMapping', id: string, canonicalEntityId: string, sourceSystem: string, namespace: string, externalId: string, createdBy: string } | null } };

export type SettingsRevokeEntitySourceMappingMutationVariables = Exact<{
  tenantId?: InputMaybe<Scalars['ID']['input']>;
  mappingId: Scalars['ID']['input'];
  reason?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type SettingsRevokeEntitySourceMappingMutation = { __typename?: 'Mutation', revokeEntitySourceMapping: { __typename?: 'RevokeEntitySourceMappingResult', status: string, reason?: string | null, canonicalEntityId?: string | null, sourceSystem?: string | null, namespace?: string | null, externalId?: string | null } };

export type SettingsCanonicalEntitySplitPreviewQueryVariables = Exact<{
  tenantId?: InputMaybe<Scalars['ID']['input']>;
  canonicalEntityId: Scalars['ID']['input'];
  assignments: Array<SplitMappingAssignmentInput> | SplitMappingAssignmentInput;
}>;
