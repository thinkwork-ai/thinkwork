...
const documents: Documents = {
  ...
  "\n  query SettingsCompanyBrainStatus {\n    companyBrainStatus {\n      tenantId\n      storageTier\n      activeBackend\n      status\n      healthStatus\n      counters {\n        ingestionQueueDepth\n        failedIngestCount\n        graphEntityCount\n        graphEdgeCount\n        sourceArtifactCount\n        vaultProjectionCount\n        latestIngestAt\n        latestProjectionAt\n        ontologyVersion\n      }\n      capabilities {\n        launch {\n          key\n          status\n          message\n          source\n        }\n        optional {\n          key\n          status\n          message\n          source\n        }\n      }\n      migration {\n        id\n        phase\n        status\n        fromStorageTier\n        toStorageTier\n        requestedAt\n        startedAt\n        completedAt\n        rollbackWindowClosesAt\n        errorMessage\n        validationSummary\n      }\n      evidence {\n        managedApplicationId\n        latestDeploymentJobId\n        backendMode\n        graphProvider\n        vectorProvider\n        embeddingModel\n        vectorDimension\n        cogneeVersion\n        cogneeEndpoint\n        s3ArtifactRoot\n        s3ManifestRoot\n        s3VaultProjectionRoot\n        neptuneGraphId\n        neptuneEndpoint\n        efsFileSystemId\n        productionPosture\n        operatorEvidence\n        migrationEvidence\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.SettingsCompanyBrainStatusDocument,
  "\n  query SettingsEmailChannel {\n    emailChannelSummary {\n      productionReady\n      ledgerEventCount\n      providers {\n        id\n        provider\n        displayName\n        status\n        activeForProduction\n        credentialConfigured\n        webhookSecretConfigured\n        defaultFromEmail\n        metadata\n        createdAt\n        updatedAt\n      }\n      domains {\n        id\n        providerInstallId\n        domain\n        ownershipType\n        status\n        sendingVerifiedAt\n        inboundVerifiedAt\n        dnsRecords\n        providerMetadata\n        createdAt\n        updatedAt\n      }\n      readinessChecks {\n        id\n        providerInstallId\n        domainId\n        checkKey\n        status\n        lastCheckedAt\n        failureCode\n        failureMessage\n        metadata\n        createdAt\n        updatedAt\n      }\n      blockingReadinessChecks {\n        id\n        providerInstallId\n        domainId\n        checkKey\n        status\n        failureCode\n        failureMessage\n      }\n      spacePolicies {\n        id\n        spaceId\n        providerInstallId\n        enabled\n        registeredUsersAllowed\n        privateSpaceMembershipRequired\n        outsideSenderDefault\n        firstSendReviewRequired\n        policy\n        allowlists {\n          id\n          valueType\n          value\n          reason\n          createdByUserId\n          createdAt\n        }\n        createdAt\n        updatedAt\n      }\n    }\n  }\n":
  ...
  "\n  mutation SettingsRequestCompanyBrainProductionMigration(\n    $input: RequestCompanyBrainProductionMigrationInput!\n  ) {\n    requestCompanyBrainProductionMigration(input: $input) {\n      id\n      phase\n      status\n      fromStorageTier\n      toStorageTier\n      requestedAt\n      startedAt\n      completedAt\n      rollbackWindowClosesAt\n      errorMessage\n      validationSummary\n    }\n  }\n":
    types.SettingsRequestCompanyBrainProductionMigrationDocument,
  "\n  mutation SettingsUpdateCompanyBrainMigration(\n    $input: UpdateCompanyBrainMigrationInput!\n  ) {\n    updateCompanyBrainMigration(input: $input) {\n      id\n      phase\n      status\n      fromStorageTier\n      toStorageTier\n      requestedAt\n      startedAt\n      completedAt\n      rollbackWindowClosesAt\n      errorMessage\n      validationSummary\n    }\n  }\n":
    types.SettingsUpdateCompanyBrainMigrationDocument,
  "\n  query SettingsDeploymentReleases($limit: Int) {\n    deploymentReleases(limit: $limit) {\n      version\n      name\n      prerelease\n      draft\n      publishedAt\n      htmlUrl\n      manifestUrl\n      manifestSha256\n      signatureUrl\n      signed\n      deployable\n    }\n  }\n":
  ...
  "\n  query SettingsDiscoverN8nWorkflows($installId: ID!) {\n    discoverN8nWorkflows(installId: $installId) {\n      installId\n      readinessState\n      readinessReasons\n      workflows {\n        externalWorkflowId\n        name\n        active\n        triggerTypes\n        lastModifiedAt\n        lastExecutionAt\n        warnings\n        connectedWorkflowId\n        connectedBindingId\n        readinessState\n        readinessReasons\n      }\n    }\n  }\n":
    types.SettingsDiscoverN8nWorkflowsDocument,
  "\n  mutation SettingsConnectN8nWorkflow($input: ConnectN8nWorkflowInput!) {\n    connectN8nWorkflow(input: $input) {\n      created\n      workflow {\n        id\n        name\n        readinessState\n      }\n      binding {\n        id\n        externalWorkflowId\n        externalWorkflowName\n        readinessState\n      }\n    }\n  }\n":
    types.SettingsConnectN8nWorkflowDocument,
  "\n  mutation SettingsUpdateN8nPluginPackageSettings(\n    $input: UpdateN8nPluginPackageSettingsInput!\n  ) {\n    updateN8nPluginPackageSettings(input: $input) {\n      settings {\n        pluginInstallId\n        installState\n        managedApplicationId\n        desiredStatus\n        currentStatus\n        desiredConfig\n        currentPackageConfig {\n          schemaVersion\n          packageSpecs\n          packageNames\n          allowExternal\n          digest\n          packages {\n            name\n            version\n            spec\n          }\n        }\n        packageImageUri\n        packageImageConfigDigest\n        lastJobId\n        lastJobStatus\n        lastJobOperation\n        lastJobError\n        lastEvidenceBucket\n        lastEvidencePrefix\n        recentAgentStepRuns {\n          id\n          status\n          resumeStatus\n          workflowId\n          workflowName\n          executionId\n          correlationId\n          instructionsPreview\n          inputPreview\n          outputPreview\n          errorMessage\n          summary\n          links\n          resumeAttemptCount\n          lastResumeHttpStatus\n          lastResumeError\n          expiresAt\n          updatedAt\n        }\n      }\n      deploymentJob {\n        id\n        appKey\n        operation\n        status\n        releaseVersion\n        manifestDigest\n        desiredConfigVersion\n        stateMachineArn\n        planExecutionArn\n        applyExecutionArn\n        codebuildBuildArn\n        planDigest\n        planSummary\n        dataImpact\n        evidenceBucket\n        evidencePrefix\n        approvalRequired\n        approvedAt\n        rejectedAt\n        errorMessage\n        createdAt\n        updatedAt\n        events {\n          id\n          eventType\n          message\n          payload\n          createdAt\n        }\n      }\n    }\n  }\n":
