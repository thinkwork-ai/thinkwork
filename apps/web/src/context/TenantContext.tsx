...
interface TenantContextValue {
   ...
   * tenant-discovery fallback found no membership either. apps/web
   ...
   *
   * Paid and deploy-provisioned owners reach this context only after an exact
   * Cognito identity enrollment; email is never an authorization signal.
   */
 ...
 * auto-promote the user to operator of a new tenant). apps/web
...
export function TenantProvider({ children }: { children: ReactNode }) {
  ...
  async function fetchTenant(targetTenantId: string) {
    ...
    try {
      ...
      console.error("[apps/web TenantContext] fetch error:", err);
