          ...
          return (
            ...
            >
              <div className="flex items-center gap-2 text-sm">
                ...
                {isFloor ? (
                  <span
                    className="inline-flex shrink-0 items-center gap-1 rounded border border-amber-500/40 px-1.5 py-0.5 text-[10px] uppercase tracking-wide text-amber-600 dark:text-amber-400"
