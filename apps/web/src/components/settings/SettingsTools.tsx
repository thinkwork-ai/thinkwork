...
const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    description:
      "Query ThinkWork Brain across memory, pages, workspace files, and approved context tools.",
    providers: [],
    kind: "policy-gated" as const,
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              {isSandbox
                ...
                : isContextEngine
                  ? "ThinkWork Brain is provided by ThinkWork and resolves source status for memory, pages, workspace files, and approved MCP context tools at query time."
                  : isEmail
