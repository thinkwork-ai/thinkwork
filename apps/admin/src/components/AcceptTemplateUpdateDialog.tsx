    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[85vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Reviewing changes to this guardrail-class file
            {folderPath ? ` in ${folderPath}/` : ""} before advancing the
        ...
        <div className="grid grid-cols-2 gap-3 flex-1 min-h-0 overflow-hidden">
          <div className="flex flex-col border rounded-md overflow-hidden">
            ...
            <pre className="flex-1 overflow-auto p-3 text-xs font-mono whitespace-pre-wrap break-words">
              {pinnedContent ??
                "(pinned content unavailable — may have been lost from version store)"}
            </pre>
          </div>
          <div className="flex flex-col border rounded-md overflow-hidden">
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={submitting || !latestContent}
          >
            {submitting && (
