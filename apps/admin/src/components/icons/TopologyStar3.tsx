/**
 * TopologyStar3 icon — based on Tabler IconTopologyStar3.
 * Rendered as an SVG component matching lucide-react's interface.
 */
export function TopologyStar3({ className }: { className?: string }) {
  return (
    <svg
