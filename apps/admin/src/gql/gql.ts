...
type Documents = {
  ...
  "\n  query SpaceMembers($id: ID!) {\n    space(id: $id) {\n      id\n      accessMode\n      members {\n        id\n        userId\n        role\n        notificationPreference\n        createdAt\n        user {\n          id\n          name\n          email\n          image\n        }\n      }\n    }\n  }\n": typeof types.SpaceMembersDocument;
  ...
  "\n  mutation SetKnowledgeGraphDeployment($enabled: Boolean!) {\n    setKnowledgeGraphDeployment(input: { enabled: $enabled }) {\n      desiredEnabled\n      workflowUrl\n      message\n    }\n  }\n": typeof types.SetKnowledgeGraphDeploymentDocument;
...
const documents: Documents = {
  ...
  "\n  mutation UpdateSpaceEmailTrigger($input: UpdateSpaceEmailTriggerInput!) {\n    updateSpaceEmailTrigger(input: $input) {\n      id\n      slug\n      emailTriggerStatus\n      emailTriggersEnabled\n      updatedAt\n    }\n  }\n":
    types.UpdateSpaceEmailTriggerDocument,
  "\n  mutation RenameTenantSlug($tenantId: ID!, $newSlug: String!) {\n    renameTenantSlug(tenantId: $tenantId, newSlug: $newSlug) {\n      id\n      slug\n      updatedAt\n    }\n  }\n":
  ...
  "\n  query ThreadSystemPrompt($tenantId: ID!, $threadId: ID!) {\n    threadTurns(tenantId: $tenantId, threadId: $threadId, limit: 1) {\n      id\n      systemPrompt\n    }\n  }\n":
    types.ThreadSystemPromptDocument,
  "\n  query ThreadProgress($tenantId: ID!, $threadId: ID!) {\n    threadProgress(tenantId: $tenantId, threadId: $threadId) {\n      threadId\n      markdown\n    }\n  }\n":
    types.ThreadProgressDocument,
  "\n  mutation UpdateThread($id: ID!, $input: UpdateThreadInput!) {\n    updateThread(id: $id, input: $input) {\n      id\n      status\n      title\n      assigneeType\n      assigneeId\n      billingCode\n      dueAt\n      updatedAt\n    }\n  }\n":
  ...
  "\n  mutation SetKnowledgeGraphDeployment($enabled: Boolean!) {\n    setKnowledgeGraphDeployment(input: { enabled: $enabled }) {\n      desiredEnabled\n      workflowUrl\n      message\n    }\n  }\n":
    types.SetKnowledgeGraphDeploymentDocument,
  "\n  query TenantMembersList($tenantId: ID!) {\n    tenantMembers(tenantId: $tenantId) {\n      id\n      tenantId\n      principalType\n      principalId\n      role\n      status\n      user {\n        id\n        name\n        email\n        image\n        phone\n        profile {\n          id\n          title\n          timezone\n          pronouns\n          callBy\n          notes\n          family\n          context\n          updatedAt\n        }\n      }\n      agent {\n        id\n        name\n        status\n        avatarUrl\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
