...
const documents: Documents = {
  ...
  "\n  mutation RemoveThreadLabel($threadId: ID!, $labelId: ID!) {\n    removeThreadLabel(threadId: $threadId, labelId: $labelId)\n  }\n":
    types.RemoveThreadLabelDocument,
  "\n  mutation CreateComplianceExport(\n    $filter: ComplianceEventFilter!\n    $format: ComplianceExportFormat!\n  ) {\n    createComplianceExport(filter: $filter, format: $format) {\n      jobId\n      tenantId\n      requestedByActorId\n      requestedAt\n      status\n      format\n      filter\n      s3Key\n      presignedUrl\n      presignedUrlExpiresAt\n      jobError\n      startedAt\n      completedAt\n    }\n  }\n":
    types.CreateComplianceExportDocument,
  "\n  query ComplianceExports {\n    complianceExports {\n      jobId\n      tenantId\n      requestedByActorId\n      requestedAt\n      status\n      format\n      filter\n      s3Key\n      presignedUrl\n      presignedUrlExpiresAt\n      jobError\n      startedAt\n      completedAt\n    }\n  }\n":
    types.ComplianceExportsDocument,
  "\n  query ComplianceEventsList(\n    $filter: ComplianceEventFilter\n    $after: String\n    $first: Int\n  ) {\n    complianceEvents(filter: $filter, after: $after, first: $first) {\n      edges {\n        node {\n          eventId\n          tenantId\n          occurredAt\n          recordedAt\n          actor\n          actorType\n          source\n          eventType\n          eventHash\n          prevHash\n          anchorStatus {\n            state\n            cadenceId\n            anchoredRecordedAt\n            nextCadenceWithinMinutes\n          }\n        }\n        cursor\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n":
    types.ComplianceEventsListDocument,
  "\n  query ComplianceEventDetail($eventId: ID!) {\n    complianceEvent(eventId: $eventId) {\n      eventId\n      tenantId\n      occurredAt\n      recordedAt\n      actor\n      actorType\n      source\n      eventType\n      eventHash\n      prevHash\n      payload\n      anchorStatus {\n        state\n        cadenceId\n        anchoredRecordedAt\n        nextCadenceWithinMinutes\n      }\n    }\n  }\n":
    types.ComplianceEventDetailDocument,
  "\n  query ComplianceEventByHash($eventHash: String!) {\n    complianceEventByHash(eventHash: $eventHash) {\n      eventId\n      tenantId\n      occurredAt\n      recordedAt\n      actor\n      actorType\n      source\n      eventType\n      eventHash\n      prevHash\n      anchorStatus {\n        state\n        cadenceId\n        anchoredRecordedAt\n        nextCadenceWithinMinutes\n      }\n    }\n  }\n":
    types.ComplianceEventByHashDocument,
  "\n  query ComplianceTenants {\n    complianceTenants\n  }\n":
  ...
  "\n  query ComputerDetail($id: ID!) {\n    computer(id: $id) {\n      id\n      tenantId\n      ownerUserId\n      owner {\n        id\n        name\n        email\n      }\n      templateId\n      template {\n        id\n        name\n        slug\n        templateKind\n        model\n      }\n      sourceAgent {\n        id\n        name\n        slug\n      }\n      name\n      slug\n      scope\n      status\n      desiredRuntimeStatus\n      runtimeStatus\n      runtimeConfig\n      liveWorkspaceRoot\n      efsAccessPointId\n      ecsServiceName\n      lastHeartbeatAt\n      lastActiveAt\n      budgetMonthlyCents\n      spentMonthlyCents\n      budgetPausedAt\n      budgetPausedReason\n      migratedFromAgentId\n      migrationMetadata\n      createdBy\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ComputerDetailDocument,
  "\n  mutation CreateComputer($input: CreateComputerInput!) {\n    createComputer(input: $input) {\n      id\n      name\n      slug\n      scope\n      status\n      desiredRuntimeStatus\n      runtimeStatus\n      tenantId\n      ownerUserId\n      templateId\n      budgetMonthlyCents\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.CreateComputerDocument,
  "\n  mutation UpdateComputer($id: ID!, $input: UpdateComputerInput!) {\n    updateComputer(id: $id, input: $input) {\n      id\n      name\n      status\n      desiredRuntimeStatus\n      runtimeStatus\n      liveWorkspaceRoot\n      efsAccessPointId\n      ecsServiceName\n      lastHeartbeatAt\n      lastActiveAt\n      budgetMonthlyCents\n      spentMonthlyCents\n      budgetPausedReason\n      updatedAt\n    }\n  }\n":
    types.UpdateComputerDocument,
  "\n  query ComputerAssignments($computerId: ID!) {\n    computerAssignments(computerId: $computerId) {\n      id\n      subjectType\n      userId\n      user {\n        id\n        name\n        email\n      }\n      teamId\n      team {\n        id\n        name\n        status\n      }\n      role\n      createdAt\n    }\n  }\n":
    types.ComputerAssignmentsDocument,
  "\n  query ComputerAccessUsers($computerId: ID!) {\n    computerAccessUsers(computerId: $computerId) {\n      userId\n      user {\n        id\n        name\n        email\n      }\n      accessSource\n      directAssignment {\n        id\n        role\n      }\n      teams {\n        id\n        name\n        status\n      }\n      teamAssignments {\n        id\n        teamId\n        role\n      }\n    }\n  }\n":
    types.ComputerAccessUsersDocument,
  "\n  query UserComputerAssignments($userId: ID!) {\n    userComputerAssignments(userId: $userId) {\n      computerId\n      computer {\n        id\n        name\n        slug\n        scope\n        status\n        runtimeStatus\n        template {\n          id\n          name\n        }\n      }\n      accessSource\n      directAssignment {\n        id\n        role\n      }\n      teams {\n        id\n        name\n        status\n      }\n      teamAssignments {\n        id\n        teamId\n        role\n      }\n    }\n  }\n":
    types.UserComputerAssignmentsDocument,
  "\n  mutation SetComputerAssignments($input: SetComputerAssignmentsInput!) {\n    setComputerAssignments(input: $input) {\n      id\n      computerId\n      subjectType\n      userId\n      teamId\n      role\n      updatedAt\n    }\n  }\n":
    types.SetComputerAssignmentsDocument,
  "\n  mutation SetUserComputerAssignments(\n    $input: SetUserComputerAssignmentsInput!\n  ) {\n    setUserComputerAssignments(input: $input) {\n      id\n      computerId\n      subjectType\n      userId\n      teamId\n      role\n      updatedAt\n    }\n  }\n":
    types.SetUserComputerAssignmentsDocument,
  "\n  mutation EnqueueComputerTask($input: EnqueueComputerTaskInput!) {\n    enqueueComputerTask(input: $input) {\n      id\n      taskType\n      status\n      input\n      output\n      error\n      idempotencyKey\n      claimedAt\n      completedAt\n      createdAt\n      updatedAt\n    }\n  }\n":
  ...
  "\n  query ThreadsList($tenantId: ID!, $status: ThreadStatus, $search: String) {\n    threads(tenantId: $tenantId, status: $status, search: $search) {\n      id\n      number\n      identifier\n      title\n      status\n      assigneeType\n      assigneeId\n      agentId\n      computerId\n      userId\n      agent {\n        id\n        name\n        avatarUrl\n      }\n      computer {\n        id\n        name\n        slug\n      }\n      user {\n        id\n        name\n        email\n        image\n      }\n      checkoutRunId\n      channel\n      costSummary\n      lastActivityAt\n      lastTurnCompletedAt\n      lastReadAt\n      archivedAt\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ThreadsListDocument,
  "\n  query ThreadsPaged(\n    $tenantId: ID!\n    $search: String\n    $showArchived: Boolean\n    $sortField: String\n    $sortDir: String\n    $limit: Int\n    $offset: Int\n    $computerId: ID\n    $spaceId: ID\n  ) {\n    threadsPaged(\n      tenantId: $tenantId\n      search: $search\n      showArchived: $showArchived\n      sortField: $sortField\n      sortDir: $sortDir\n      limit: $limit\n      offset: $offset\n      computerId: $computerId\n      spaceId: $spaceId\n    ) {\n      items {\n        id\n        number\n        identifier\n        title\n        status\n        assigneeType\n        assigneeId\n        agentId\n        computerId\n        spaceId\n        userId\n        agent {\n          id\n          name\n          avatarUrl\n        }\n        computer {\n          id\n          name\n          slug\n        }\n        user {\n          id\n          name\n          email\n          image\n        }\n        checkoutRunId\n        channel\n        costSummary\n        lastActivityAt\n        lastTurnCompletedAt\n        lastReadAt\n        archivedAt\n        createdAt\n        updatedAt\n      }\n      totalCount\n    }\n  }\n":
    types.ThreadsPagedDocument,
  "\n  query ThreadDetail($id: ID!) {\n    thread(id: $id) {\n      id\n      tenantId\n      number\n      identifier\n      title\n      status\n      lifecycleStatus\n      assigneeType\n      assigneeId\n      agentId\n      computerId\n      userId\n      agent {\n        id\n        name\n        avatarUrl\n      }\n      computer {\n        id\n        name\n        slug\n      }\n      user {\n        id\n        name\n        email\n        image\n      }\n      channel\n      messages(limit: 50) {\n        edges {\n          node {\n            id\n            threadId\n            tenantId\n            role\n            content\n            senderType\n            senderId\n            toolCalls\n            toolResults\n            metadata\n            tokenCount\n            createdAt\n            durableArtifact {\n              id\n              title\n              type\n              status\n            }\n          }\n        }\n      }\n      costSummary\n      checkoutRunId\n      checkoutVersion\n      billingCode\n      labels\n      metadata\n      dueAt\n      startedAt\n      completedAt\n      cancelledAt\n      closedAt\n      createdByType\n      createdById\n      attachments {\n        id\n        threadId\n        name\n        mimeType\n        sizeBytes\n        uploadedBy\n        createdAt\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ThreadDetailDocument,
  "\n  mutation UpdateThread($id: ID!, $input: UpdateThreadInput!) {\n    updateThread(id: $id, input: $input) {\n      id\n      status\n      title\n      assigneeType\n      assigneeId\n      billingCode\n      dueAt\n      updatedAt\n    }\n  }\n":
    types.UpdateThreadDocument,
  "\n  mutation DeleteThread($id: ID!) {\n    deleteThread(id: $id)\n  }\n":
    types.DeleteThreadDocument,
  "\n  mutation CheckoutThread($id: ID!, $input: CheckoutThreadInput!) {\n    checkoutThread(id: $id, input: $input) {\n      id\n      checkoutRunId\n      checkoutVersion\n    }\n  }\n":
    types.CheckoutThreadDocument,
  "\n  mutation ReleaseThread($id: ID!, $input: ReleaseThreadInput!) {\n    releaseThread(id: $id, input: $input) {\n      id\n      checkoutRunId\n      status\n    }\n  }\n":
    types.ReleaseThreadDocument,
  "\n  query TeamsList($tenantId: ID!) {\n    teams(tenantId: $tenantId) {\n      id\n      name\n      description\n      type\n      status\n      budgetMonthlyCents\n      agents {\n        id\n        agentId\n        agent {\n          id\n          name\n          status\n          avatarUrl\n        }\n        role\n      }\n      users {\n        id\n        userId\n        role\n      }\n      createdAt\n    }\n  }\n":
    types.TeamsListDocument,
  "\n  query TeamDetail($id: ID!) {\n    team(id: $id) {\n      id\n      tenantId\n      name\n      description\n      type\n      status\n      budgetMonthlyCents\n      metadata\n      agents {\n        id\n        agentId\n        agent {\n          id\n          name\n          role\n          status\n          avatarUrl\n        }\n        role\n        createdAt\n      }\n      users {\n        id\n        userId\n        user {\n          id\n          name\n          email\n        }\n        role\n        createdAt\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.TeamDetailDocument,
  "\n  query RoutinesList($tenantId: ID!) {\n    routines(tenantId: $tenantId) {\n      id\n      name\n      description\n      status\n      lastRunAt\n      engine\n      createdAt\n    }\n  }\n":
    types.RoutinesListDocument,
  "\n  query RoutineDetail($id: ID!) {\n    routine(id: $id) {\n      id\n      tenantId\n      name\n      description\n      type\n      status\n      schedule\n      engine\n      currentVersion\n      config\n      lastRunAt\n      nextRunAt\n      agentId\n      agent {\n        id\n        name\n        avatarUrl\n      }\n      teamId\n      team {\n        id\n        name\n      }\n      triggers {\n        id\n        triggerType\n        config\n        enabled\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.RoutineDetailDocument,
  "\n  mutation CreateRoutine($input: CreateRoutineInput!) {\n    createRoutine(input: $input) {\n      id\n      name\n      currentVersion\n    }\n  }\n":
    types.CreateRoutineDocument,
  "\n  mutation PlanRoutineDraft($input: PlanRoutineDraftInput!) {\n    planRoutineDraft(input: $input) {\n      title\n      description\n      kind\n      asl\n      markdownSummary\n      stepManifest\n      steps {\n        nodeId\n        recipeId\n        recipeName\n        label\n        args\n        configFields {\n          key\n          label\n          value\n          inputType\n          control\n          required\n          editable\n          options\n          placeholder\n          helpText\n          min\n          max\n          pattern\n        }\n      }\n    }\n  }\n":
    types.PlanRoutineDraftDocument,
  "\n  query RoutineRecipeCatalog($tenantId: ID!) {\n    routineRecipeCatalog(tenantId: $tenantId) {\n      id\n      displayName\n      description\n      category\n      hitlCapable\n      defaultArgs\n      configFields {\n        key\n        label\n        value\n        inputType\n        control\n        required\n        editable\n        options\n        placeholder\n        helpText\n        min\n        max\n        pattern\n      }\n    }\n  }\n":
    types.RoutineRecipeCatalogDocument,
  "\n  query TenantCredentials($tenantId: ID!, $status: TenantCredentialStatus) {\n    tenantCredentials(tenantId: $tenantId, status: $status) {\n      id\n      tenantId\n      displayName\n      slug\n      kind\n      status\n      metadataJson\n      schemaJson\n      eventbridgeConnectionArn\n      lastUsedAt\n      lastValidatedAt\n      createdAt\n      updatedAt\n      deletedAt\n    }\n  }\n":
    types.TenantCredentialsDocument,
  "\n  query CredentialRoutineUsage($tenantId: ID!) {\n    routines(tenantId: $tenantId) {\n      id\n      name\n      status\n      config\n      engine\n      updatedAt\n    }\n  }\n":
    types.CredentialRoutineUsageDocument,
  "\n  mutation CreateTenantCredential($input: CreateTenantCredentialInput!) {\n    createTenantCredential(input: $input) {\n      id\n      displayName\n      slug\n      kind\n      status\n      metadataJson\n      eventbridgeConnectionArn\n      lastValidatedAt\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.CreateTenantCredentialDocument,
  "\n  mutation UpdateTenantCredential(\n    $id: ID!\n    $input: UpdateTenantCredentialInput!\n  ) {\n    updateTenantCredential(id: $id, input: $input) {\n      id\n      displayName\n      slug\n      status\n      metadataJson\n      updatedAt\n    }\n  }\n":
    types.UpdateTenantCredentialDocument,
  "\n  mutation RotateTenantCredential($input: RotateTenantCredentialInput!) {\n    rotateTenantCredential(input: $input) {\n      id\n      status\n      lastValidatedAt\n      updatedAt\n    }\n  }\n":
  ...
  "\n  query RoutineAslVersionDetail($id: ID!) {\n    routineAslVersion(id: $id) {\n      id\n      versionNumber\n      aslJson\n      markdownSummary\n      stepManifestJson\n      createdAt\n    }\n  }\n":
    types.RoutineAslVersionDetailDocument,
  "\n  query InboxItemsList($tenantId: ID!, $status: InboxItemStatus) {\n    inboxItems(tenantId: $tenantId, status: $status) {\n      id\n      type\n      status\n      title\n      description\n      requesterType\n      requesterId\n      entityType\n      entityId\n      revision\n      expiresAt\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.InboxItemsListDocument,
  "\n  query InboxItemDetail($id: ID!) {\n    inboxItem(id: $id) {\n      id\n      tenantId\n      type\n      status\n      title\n      description\n      requesterType\n      requesterId\n      entityType\n      entityId\n      config\n      revision\n      reviewNotes\n      decidedBy\n      decidedAt\n      expiresAt\n      comments {\n        id\n        authorType\n        authorId\n        content\n        createdAt\n      }\n      links {\n        id\n        linkedType\n        linkedId\n      }\n      linkedThreads {\n        id\n        number\n        identifier\n        title\n        status\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.InboxItemDetailDocument,
  "\n  mutation ApproveInboxItem($id: ID!, $input: ApproveInboxItemInput) {\n    approveInboxItem(id: $id, input: $input) {\n      id\n      status\n      reviewNotes\n      decidedAt\n      updatedAt\n    }\n  }\n":
    types.ApproveInboxItemDocument,
  "\n  mutation RejectInboxItem($id: ID!, $input: RejectInboxItemInput) {\n    rejectInboxItem(id: $id, input: $input) {\n      id\n      status\n      reviewNotes\n      decidedAt\n      updatedAt\n    }\n  }\n":
    types.RejectInboxItemDocument,
  "\n  mutation RequestRevision($id: ID!, $input: RequestRevisionInput!) {\n    requestRevision(id: $id, input: $input) {\n      id\n      status\n      reviewNotes\n      updatedAt\n    }\n  }\n":
    types.RequestRevisionDocument,
  "\n  mutation ResubmitInboxItem($id: ID!, $input: ResubmitInboxItemInput) {\n    resubmitInboxItem(id: $id, input: $input) {\n      id\n      status\n      revision\n      updatedAt\n    }\n  }\n":
    types.ResubmitInboxItemDocument,
  "\n  mutation AddInboxItemComment($input: AddInboxItemCommentInput!) {\n    addInboxItemComment(input: $input) {\n      id\n      authorType\n      authorId\n      content\n      createdAt\n    }\n  }\n":
    types.AddInboxItemCommentDocument,
  "\n  query ActivityLog(\n    $tenantId: ID!\n    $entityType: String\n    $entityId: ID\n    $limit: Int\n  ) {\n    activityLog(\n      tenantId: $tenantId\n      entityType: $entityType\n      entityId: $entityId\n      limit: $limit\n    ) {\n      id\n      actorType\n      actorId\n      action\n      entityType\n      entityId\n      changes\n      createdAt\n    }\n  }\n":
    types.ActivityLogDocument,
  "\n  query TenantDetail($id: ID!) {\n    tenant(id: $id) {\n      id\n      name\n      slug\n      plan\n      issuePrefix\n      issueCounter\n      settings {\n        id\n        defaultModel\n        budgetMonthlyCents\n        autoCloseThreadMinutes\n        maxAgents\n        features\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.TenantDetailDocument,
  "\n  query DeploymentStatus {\n    deploymentStatus {\n      stage\n      source\n      region\n      accountId\n      bucketName\n      databaseEndpoint\n      ecrUrl\n      adminUrl\n      docsUrl\n      apiEndpoint\n      appsyncUrl\n      appsyncRealtimeUrl\n      hindsightEndpoint\n      agentcoreStatus\n      hindsightEnabled\n      managedMemoryEnabled\n    }\n  }\n":
    types.DeploymentStatusDocument,
  "\n  query TenantMembersList($tenantId: ID!) {\n    tenantMembers(tenantId: $tenantId) {\n      id\n      tenantId\n      principalType\n      principalId\n      role\n      status\n      user {\n        id\n        name\n        email\n        image\n      }\n      agent {\n        id\n        name\n        status\n        avatarUrl\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.TenantMembersListDocument,
  "\n  mutation InviteMember($tenantId: ID!, $input: InviteMemberInput!) {\n    inviteMember(tenantId: $tenantId, input: $input) {\n      id\n      tenantId\n      principalType\n      principalId\n      role\n      status\n      user {\n        id\n        name\n        email\n      }\n      createdAt\n    }\n  }\n":
  ...
  "\n  query CostByAgent($tenantId: ID!, $from: AWSDateTime, $to: AWSDateTime) {\n    costByAgent(tenantId: $tenantId, from: $from, to: $to) {\n      agentId\n      agentName\n      totalUsd\n      eventCount\n    }\n  }\n":
    types.CostByAgentDocument,
  "\n  query CostByModel($tenantId: ID!, $from: AWSDateTime, $to: AWSDateTime) {\n    costByModel(tenantId: $tenantId, from: $from, to: $to) {\n      model\n      totalUsd\n      inputTokens\n      outputTokens\n    }\n  }\n":
    types.CostByModelDocument,
  "\n  query CostTimeSeries($tenantId: ID!, $days: Int) {\n    costTimeSeries(tenantId: $tenantId, days: $days) {\n      day\n      totalUsd\n      llmUsd\n      computeUsd\n      toolsUsd\n      eventCount\n    }\n  }\n":
    types.CostTimeSeriesDocument,
  "\n  query BudgetStatus($tenantId: ID!) {\n    budgetStatus(tenantId: $tenantId) {\n      policy {\n        id\n        tenantId\n        agentId\n        scope\n        period\n        limitUsd\n        actionOnExceed\n        enabled\n      }\n      spentUsd\n      remainingUsd\n      percentUsed\n      status\n    }\n  }\n":
    types.BudgetStatusDocument,
  "\n  mutation UpsertBudgetPolicy(\n    $tenantId: ID!\n    $input: UpsertBudgetPolicyInput!\n  ) {\n    upsertBudgetPolicy(tenantId: $tenantId, input: $input) {\n      id\n      scope\n      limitUsd\n      actionOnExceed\n      enabled\n    }\n  }\n":
    types.UpsertBudgetPolicyDocument,
  "\n  mutation DeleteBudgetPolicy($id: ID!) {\n    deleteBudgetPolicy(id: $id)\n  }\n":
    types.DeleteBudgetPolicyDocument,
  "\n  mutation UnpauseAgent($agentId: ID!) {\n    unpauseAgent(agentId: $agentId) {\n      id\n      name\n    }\n  }\n":
    types.UnpauseAgentDocument,
  "\n  mutation NotifyAgentStatus(\n    $agentId: ID!\n    $tenantId: ID!\n    $status: String!\n    $name: String!\n  ) {\n    notifyAgentStatus(\n      agentId: $agentId\n      tenantId: $tenantId\n      status: $status\n      name: $name\n    ) {\n      agentId\n      tenantId\n      status\n      name\n      updatedAt\n    }\n  }\n":
    types.NotifyAgentStatusDocument,
  "\n  subscription OnAgentStatusChanged($tenantId: ID!) {\n    onAgentStatusChanged(tenantId: $tenantId) {\n      agentId\n      tenantId\n      status\n      name\n      updatedAt\n    }\n  }\n":
  ...
  '\n  query ActiveTurns($tenantId: ID!) {\n    running: threadTurns(tenantId: $tenantId, status: "running") {\n      id\n      tenantId\n      threadId\n      agentId\n      status\n      startedAt\n    }\n    queued: threadTurns(tenantId: $tenantId, status: "queued") {\n      id\n      tenantId\n      threadId\n      agentId\n      status\n      startedAt\n    }\n    queuedWakeups(tenantId: $tenantId) {\n      id\n      tenantId\n      agentId\n      source\n      triggerDetail\n      status\n    }\n  }\n':
    types.ActiveTurnsDocument,
  "\n  subscription OnNewMessage($threadId: ID!) {\n    onNewMessage(threadId: $threadId) {\n      messageId\n      threadId\n      tenantId\n      role\n      content\n      senderType\n      senderId\n      createdAt\n    }\n  }\n":
    types.OnNewMessageDocument,
  "\n  query ArtifactsList(\n    $tenantId: ID!\n    $threadId: ID\n    $agentId: ID\n    $type: ArtifactType\n    $status: ArtifactStatus\n    $limit: Int\n  ) {\n    artifacts(\n      tenantId: $tenantId\n      threadId: $threadId\n      agentId: $agentId\n      type: $type\n      status: $status\n      limit: $limit\n    ) {\n      id\n      tenantId\n      agentId\n      threadId\n      title\n      type\n      status\n      summary\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ArtifactsListDocument,
  "\n  query ArtifactDetail($id: ID!) {\n    artifact(id: $id) {\n      id\n      title\n      type\n      status\n      content\n      summary\n      agentId\n      threadId\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ArtifactDetailDocument,
  "\n  query AdminApplets(\n    $tenantId: ID!\n    $userId: ID\n    $cursor: String\n    $limit: Int\n  ) {\n    adminApplets(\n      tenantId: $tenantId\n      userId: $userId\n      cursor: $cursor\n      limit: $limit\n    ) {\n      nodes {\n        appId\n        name\n        version\n        tenantId\n        threadId\n        prompt\n        agentVersion\n        modelId\n        generatedAt\n        stdlibVersionAtGeneration\n        artifact {\n          id\n          agentId\n          threadId\n          createdAt\n          updatedAt\n        }\n      }\n      nextCursor\n    }\n  }\n":
    types.AdminAppletsDocument,
  "\n  mutation UpdateTenantArtifactStyle(\n    $tenantId: ID!\n    $input: UpdateTenantSettingsInput!\n  ) {\n    updateTenantSettings(tenantId: $tenantId, input: $input) {\n      id\n      features\n      updatedAt\n    }\n  }\n":
    types.UpdateTenantArtifactStyleDocument,
  "\n  query AdminApplet($appId: ID!) {\n    adminApplet(appId: $appId) {\n      applet {\n        appId\n        name\n        version\n        tenantId\n        threadId\n        prompt\n        agentVersion\n        modelId\n        generatedAt\n        stdlibVersionAtGeneration\n        artifact {\n          id\n          agentId\n          threadId\n          createdAt\n          updatedAt\n        }\n      }\n      source\n      metadata\n      themeCss\n    }\n  }\n":
    types.AdminAppletDocument,
  "\n  mutation AdminUpdateAppletSource($input: AdminUpdateAppletSourceInput!) {\n    adminUpdateAppletSource(input: $input) {\n      ok\n      appId\n      version\n      validated\n      persisted\n      errors\n    }\n  }\n":
  ...
  "\n  query MemorySearch(\n    $userId: ID!\n    $query: String!\n    $strategy: MemoryStrategy\n    $limit: Int\n  ) {\n    memorySearch(\n      userId: $userId\n      query: $query\n      strategy: $strategy\n      limit: $limit\n    ) {\n      records {\n        memoryRecordId\n        content {\n          text\n        }\n        score\n        namespace\n        strategy\n        createdAt\n        threadId\n      }\n      totalCount\n    }\n  }\n":
    types.MemorySearchDocument,
  "\n  query MemorySystemConfig {\n    memorySystemConfig {\n      managedMemoryEnabled\n      hindsightEnabled\n    }\n  }\n":
    types.MemorySystemConfigDocument,
  "\n  query ThreadIdleLearningRuns($userId: ID!, $limit: Int) {\n    threadIdleLearningRuns(userId: $userId, limit: $limit) {\n      id\n      threadId\n      computerId\n      requesterUserId\n      status\n      startedAt\n      finishedAt\n      reportS3Key\n      error\n      canRollback\n      changedFiles {\n        path\n        beforeHash\n        afterHash\n        snapshotKey\n        hindsightDocumentId\n        hindsightStatus\n      }\n    }\n  }\n":
    types.ThreadIdleLearningRunsDocument,
  "\n  mutation RollbackThreadIdleLearningRun($userId: ID!, $runId: ID!) {\n    rollbackThreadIdleLearningRun(userId: $userId, runId: $runId) {\n      id\n      status\n      error\n      canRollback\n      changedFiles {\n        path\n        hindsightStatus\n      }\n    }\n  }\n":
    types.RollbackThreadIdleLearningRunDocument,
  "\n  query OntologyDefinitions($tenantId: ID!) {\n    ontologyDefinitions(tenantId: $tenantId) {\n      tenantId\n      activeVersion {\n        id\n        versionNumber\n        status\n        sourceChangeSetId\n        activatedAt\n        createdAt\n      }\n      entityTypes {\n        id\n        slug\n        name\n        description\n        broadType\n        aliases\n        propertiesSchema\n        guidanceNotes\n        lifecycleStatus\n        approvedAt\n        updatedAt\n        facetTemplates {\n          id\n          slug\n          heading\n          facetType\n          position\n          sourcePriority\n          prompt\n          guidanceNotes\n          lifecycleStatus\n        }\n        externalMappings {\n          id\n          subjectKind\n          subjectId\n          mappingKind\n          vocabulary\n          externalUri\n          externalLabel\n          notes\n        }\n      }\n      relationshipTypes {\n        id\n        slug\n        name\n        description\n        inverseName\n        sourceTypeSlugs\n        targetTypeSlugs\n        aliases\n        guidanceNotes\n        lifecycleStatus\n        approvedAt\n        updatedAt\n        externalMappings {\n          id\n          subjectKind\n          subjectId\n          mappingKind\n          vocabulary\n          externalUri\n          externalLabel\n          notes\n        }\n      }\n      facetTemplates {\n        id\n        entityTypeId\n        slug\n        heading\n        facetType\n        position\n        sourcePriority\n        prompt\n        guidanceNotes\n        lifecycleStatus\n      }\n      externalMappings {\n        id\n        subjectKind\n        subjectId\n        mappingKind\n        vocabulary\n        externalUri\n        externalLabel\n        notes\n      }\n    }\n  }\n":
    types.OntologyDefinitionsDocument,
  "\n  query OntologyChangeSets($tenantId: ID!, $status: OntologyChangeSetStatus) {\n    ontologyChangeSets(tenantId: $tenantId, status: $status) {\n      id\n      tenantId\n      title\n      summary\n      status\n      confidence\n      observedFrequency\n      expectedImpact\n      proposedBy\n      approvedByUserId\n      approvedAt\n      rejectedByUserId\n      rejectedAt\n      appliedVersionId\n      createdAt\n      updatedAt\n      items {\n        id\n        itemType\n        action\n        status\n        targetKind\n        targetSlug\n        title\n        description\n        proposedValue\n        editedValue\n        confidence\n        position\n        evidenceExamples {\n          id\n          sourceKind\n          sourceRef\n          sourceLabel\n          quote\n          metadata\n          observedAt\n        }\n      }\n      evidenceExamples {\n        id\n        sourceKind\n        sourceRef\n        sourceLabel\n        quote\n        metadata\n        observedAt\n      }\n    }\n  }\n":
    types.OntologyChangeSetsDocument,
  "\n  query OntologySuggestionScanJob($tenantId: ID!, $jobId: ID!) {\n    ontologySuggestionScanJob(tenantId: $tenantId, jobId: $jobId) {\n      id\n      status\n      trigger\n      dedupeKey\n      startedAt\n      finishedAt\n      error\n      result\n      metrics\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.OntologySuggestionScanJobDocument,
  "\n  query OntologyReprocessJob($tenantId: ID!, $jobId: ID!) {\n    ontologyReprocessJob(tenantId: $tenantId, jobId: $jobId) {\n      id\n      changeSetId\n      ontologyVersionId\n      dedupeKey\n      status\n      attempt\n      claimedAt\n      startedAt\n      finishedAt\n      input\n      impact\n      metrics\n      error\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.OntologyReprocessJobDocument,
  "\n  mutation StartOntologySuggestionScan(\n    $input: StartOntologySuggestionScanInput!\n  ) {\n    startOntologySuggestionScan(input: $input) {\n      id\n      status\n      trigger\n      dedupeKey\n      result\n      metrics\n      error\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.StartOntologySuggestionScanDocument,
  "\n  mutation UpdateOntologyChangeSet($input: UpdateOntologyChangeSetInput!) {\n    updateOntologyChangeSet(input: $input) {\n      id\n      title\n      summary\n      status\n      confidence\n      observedFrequency\n      expectedImpact\n      updatedAt\n      items {\n        id\n        status\n        editedValue\n        updatedAt\n      }\n    }\n  }\n":
    types.UpdateOntologyChangeSetDocument,
  "\n  mutation UpdateOntologyEntityType($input: UpdateOntologyEntityTypeInput!) {\n    updateOntologyEntityType(input: $input) {\n      id\n      slug\n      name\n      description\n      broadType\n      aliases\n      guidanceNotes\n      lifecycleStatus\n      approvedAt\n      updatedAt\n      facetTemplates {\n        id\n        slug\n        heading\n        facetType\n        position\n        sourcePriority\n        prompt\n        guidanceNotes\n        lifecycleStatus\n      }\n      externalMappings {\n        id\n        subjectKind\n        subjectId\n        mappingKind\n        vocabulary\n        externalUri\n        externalLabel\n        notes\n      }\n    }\n  }\n":
    types.UpdateOntologyEntityTypeDocument,
  "\n  mutation UpdateOntologyRelationshipType(\n    $input: UpdateOntologyRelationshipTypeInput!\n  ) {\n    updateOntologyRelationshipType(input: $input) {\n      id\n      slug\n      name\n      description\n      inverseName\n      sourceTypeSlugs\n      targetTypeSlugs\n      aliases\n      guidanceNotes\n      lifecycleStatus\n      approvedAt\n      updatedAt\n      externalMappings {\n        id\n        subjectKind\n        subjectId\n        mappingKind\n        vocabulary\n        externalUri\n        externalLabel\n        notes\n      }\n    }\n  }\n":
    types.UpdateOntologyRelationshipTypeDocument,
  "\n  mutation ApproveOntologyChangeSet($input: ApproveOntologyChangeSetInput!) {\n    approveOntologyChangeSet(input: $input) {\n      id\n      status\n      approvedAt\n      appliedVersionId\n      updatedAt\n    }\n  }\n":
    types.ApproveOntologyChangeSetDocument,
  "\n  mutation RejectOntologyChangeSet($input: RejectOntologyChangeSetInput!) {\n    rejectOntologyChangeSet(input: $input) {\n      id\n      status\n      rejectedAt\n      updatedAt\n    }\n  }\n":
    types.RejectOntologyChangeSetDocument,
  "\n  query AgentTemplatesList($tenantId: ID!) {\n    agentTemplates(tenantId: $tenantId) {\n      id\n      tenantId\n      name\n      slug\n      description\n      category\n      icon\n      templateKind\n      source\n      runtime\n      model\n      guardrailId\n      blockedTools\n      config\n      skills\n      knowledgeBaseIds\n      isPublished\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.AgentTemplatesListDocument,
  "\n  query ComputerTemplatesList($tenantId: ID!) {\n    computerTemplates(tenantId: $tenantId) {\n      id\n      tenantId\n      name\n      slug\n      description\n      category\n      icon\n      templateKind\n      source\n      runtime\n      model\n      isPublished\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ComputerTemplatesListDocument,
  "\n  query AgentTemplateDetail($id: ID!) {\n    agentTemplate(id: $id) {\n      id\n      tenantId\n      name\n      slug\n      description\n      category\n      icon\n      templateKind\n      source\n      runtime\n      model\n      guardrailId\n      blockedTools\n      config\n      skills\n      sandbox\n      browser\n      webSearch\n      sendEmail\n      contextEngine\n      knowledgeBaseIds\n      isPublished\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.AgentTemplateDetailDocument,
  "\n  mutation CreateAgentTemplate($input: CreateAgentTemplateInput!) {\n    createAgentTemplate(input: $input) {\n      id\n      name\n      slug\n      templateKind\n      runtime\n    }\n  }\n":
    types.CreateAgentTemplateDocument,
  "\n  mutation UpdateAgentTemplate($id: ID!, $input: UpdateAgentTemplateInput!) {\n    updateAgentTemplate(id: $id, input: $input) {\n      id\n      name\n      slug\n      templateKind\n      runtime\n      model\n      guardrailId\n      blockedTools\n      config\n      skills\n      sandbox\n      browser\n      webSearch\n      sendEmail\n      contextEngine\n      knowledgeBaseIds\n      updatedAt\n    }\n  }\n":
    types.UpdateAgentTemplateDocument,
  "\n  mutation DeleteAgentTemplate($id: ID!) {\n    deleteAgentTemplate(id: $id)\n  }\n":
    types.DeleteAgentTemplateDocument,
  "\n  query TenantSandboxStatus($id: ID!) {\n    tenant(id: $id) {\n      id\n      sandboxEnabled\n      complianceTier\n      sandboxInterpreterPublicId\n      sandboxInterpreterInternalId\n    }\n  }\n":
    types.TenantSandboxStatusDocument,
  "\n  mutation CreateAgentFromTemplate($input: CreateAgentFromTemplateInput!) {\n    createAgentFromTemplate(input: $input) {\n      id\n      name\n      slug\n    }\n  }\n":
    types.CreateAgentFromTemplateDocument,
  "\n  query LinkedAgentsForTemplate($templateId: ID!) {\n    linkedAgentsForTemplate(templateId: $templateId) {\n      id\n      name\n      slug\n      role\n      status\n      updatedAt\n    }\n  }\n":
    types.LinkedAgentsForTemplateDocument,
  "\n  query TemplateSyncDiff($templateId: ID!, $agentId: ID!) {\n    templateSyncDiff(templateId: $templateId, agentId: $agentId) {\n      roleChange {\n        current\n        target\n      }\n      skillsAdded\n      skillsRemoved\n      skillsChanged\n      permissionsChanges {\n        skillId\n        added\n        removed\n      }\n      kbsAdded\n      kbsRemoved\n      filesAdded\n      filesModified\n      filesSame\n    }\n  }\n":
    types.TemplateSyncDiffDocument,
  "\n  query AgentVersionsList($agentId: ID!, $limit: Int) {\n    agentVersions(agentId: $agentId, limit: $limit) {\n      id\n      agentId\n      versionNumber\n      label\n      createdBy\n      createdAt\n    }\n  }\n":
    types.AgentVersionsListDocument,
  "\n  mutation SyncTemplateToAgent($templateId: ID!, $agentId: ID!) {\n    syncTemplateToAgent(templateId: $templateId, agentId: $agentId) {\n      id\n      name\n      role\n      updatedAt\n    }\n  }\n":
  ...
  "\n  query AdminWikiPage(\n    $tenantId: ID!\n    $userId: ID!\n    $type: WikiPageType!\n    $slug: String!\n  ) {\n    wikiPage(tenantId: $tenantId, userId: $userId, type: $type, slug: $slug) {\n      id\n      type\n      entitySubtype\n      displayType\n      slug\n      title\n      summary\n      bodyMd\n      status\n      lastCompiledAt\n      updatedAt\n      aliases\n      sections {\n        id\n        sectionSlug\n        heading\n        bodyMd\n        position\n        lastSourceAt\n      }\n    }\n  }\n":
    types.AdminWikiPageDocument,
  "\n  query AdminWikiBacklinks($pageId: ID!) {\n    wikiBacklinks(pageId: $pageId) {\n      id\n      type\n      entitySubtype\n      displayType\n      slug\n      title\n      summary\n    }\n  }\n":
    types.AdminWikiBacklinksDocument,
  "\n  query AdminRecentWikiPages($userId: ID!, $limit: Int) {\n    recentWikiPages(userId: $userId, limit: $limit) {\n      id\n      type\n      entitySubtype\n      displayType\n      slug\n      title\n      summary\n      lastCompiledAt\n      updatedAt\n    }\n  }\n":
    types.AdminRecentWikiPagesDocument,
  "\n  query AdminWikiSearch(\n    $tenantId: ID!\n    $userId: ID!\n    $query: String!\n    $limit: Int\n  ) {\n    wikiSearch(\n      tenantId: $tenantId\n      userId: $userId\n      query: $query\n      limit: $limit\n    ) {\n      score\n      matchedAlias\n      page {\n        id\n        type\n        entitySubtype\n        displayType\n        slug\n        title\n        summary\n        lastCompiledAt\n        updatedAt\n      }\n    }\n  }\n":
    types.AdminWikiSearchDocument,
  "\n  query AdminWikiCompileJobs($tenantId: ID!, $ownerId: ID, $limit: Int) {\n    wikiCompileJobs(tenantId: $tenantId, ownerId: $ownerId, limit: $limit) {\n      id\n      tenantId\n      ownerId\n      status\n      trigger\n      attempt\n      startedAt\n      finishedAt\n      error\n      metrics\n      createdAt\n    }\n  }\n":
    types.AdminWikiCompileJobsDocument,
  "\n  query ThreadTraces($threadId: ID!, $tenantId: ID!) {\n    threadTraces(threadId: $threadId, tenantId: $tenantId) {\n      traceId\n      threadId\n      agentId\n      agentName\n      model\n      inputTokens\n      outputTokens\n      durationMs\n      costUsd\n      estimated\n      createdAt\n    }\n  }\n":
