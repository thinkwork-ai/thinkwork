...
const documents: Documents = {
  ...
  "\n  query ComputerTasks($computerId: ID!, $limit: Int) {\n    computerTasks(computerId: $computerId, limit: $limit) {\n      id\n      taskType\n      status\n      input\n      output\n      error\n      idempotencyKey\n      claimedAt\n      completedAt\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ComputerTasksDocument,
  "\n  query ComputerThreads($tenantId: ID!, $computerId: ID!, $limit: Int) {\n    threads(tenantId: $tenantId, computerId: $computerId, limit: $limit) {\n      id\n      number\n      identifier\n      title\n      status\n      channel\n      costSummary\n      lastResponsePreview\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.ComputerThreadsDocument,
  "\n  query ComputerEvents($computerId: ID!, $limit: Int) {\n    computerEvents(computerId: $computerId, limit: $limit) {\n      id\n      taskId\n      eventType\n      level\n      payload\n      createdAt\n    }\n  }\n":
    types.ComputerEventsDocument,
  "\n  mutation EnqueueComputerTask($input: EnqueueComputerTaskInput!) {\n    enqueueComputerTask(input: $input) {\n      id\n      taskType\n      status\n      input\n      output\n      error\n      idempotencyKey\n      claimedAt\n      completedAt\n      createdAt\n      updatedAt\n    }\n  }\n":
  ...
  "\n  query ConnectorExecutionsList(\n    $connectorId: ID\n    $status: ConnectorExecutionState\n    $limit: Int\n    $cursor: String\n  ) {\n    connectorExecutions(\n      connectorId: $connectorId\n      status: $status\n      limit: $limit\n      cursor: $cursor\n    ) {\n      id\n      tenantId\n      connectorId\n      externalRef\n      currentState\n      startedAt\n      finishedAt\n      errorClass\n      outcomePayload\n      retryAttempt\n      createdAt\n    }\n  }\n":
    types.ConnectorExecutionsListDocument,
  "\n  query ConnectorRunLifecycles($connectorId: ID, $limit: Int, $cursor: String) {\n    connectorRunLifecycles(\n      connectorId: $connectorId\n      limit: $limit\n      cursor: $cursor\n    ) {\n      execution {\n        id\n        tenantId\n        connectorId\n        externalRef\n        currentState\n        startedAt\n        finishedAt\n        errorClass\n        outcomePayload\n        retryAttempt\n        createdAt\n      }\n      connector {\n        id\n        type\n        name\n        status\n      }\n      computerTask {\n        id\n        status\n        output\n        error\n        completedAt\n        createdAt\n      }\n      delegation {\n        id\n        status\n        agentId\n        outputArtifacts\n        result\n        error\n        completedAt\n        createdAt\n      }\n      threadTurn {\n        id\n        threadId\n        agentId\n        status\n        resultJson\n        error\n        errorCode\n        startedAt\n        finishedAt\n        createdAt\n      }\n      threadId\n      messageId\n      computerId\n    }\n  }\n":
    types.ConnectorRunLifecyclesDocument,
  "\n  query AgentEmailCapability($agentId: ID!) {\n    agentEmailCapability(agentId: $agentId) {\n      id\n      agentId\n      enabled\n      emailAddress\n      vanityAddress\n      allowedSenders\n    }\n  }\n":
