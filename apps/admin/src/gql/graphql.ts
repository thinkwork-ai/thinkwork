...
export type UpdateSpaceEmailTriggerMutation = {
  __typename?: "Mutation";
...
export type ThreadSystemPromptQuery = {
  __typename?: "Query";
  threadTurns: Array<{
    __typename?: "ThreadTurn";
    id: string;
...
export type ThreadProgressQuery = {
  __typename?: "Query";
  threadProgress?: {
    __typename?: "ThreadProgress";
    threadId: string;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "emailTriggerStatus" },
                },
                {
                  kind: "Field",
...
>;
export const UpdateSpaceEmailTriggerDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateSpaceEmailTrigger" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "UpdateSpaceEmailTriggerInput" },
            },
          },
        },
      ],
  ...
  UpdateSpaceEmailTriggerMutationVariables
>;
...
} as unknown as DocumentNode<SpaceMembersQuery, SpaceMembersQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "lastRuntimeType" },
                },
                { kind: "Field", name: { kind: "Name", value: "lastModel" } },
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "lastModel" },
                      },
                      {
                        kind: "Field",
...
export const ThreadSystemPromptDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ThreadSystemPrompt" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const ThreadProgressDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<ThreadProgressQuery, ThreadProgressQueryVariables>;
