...
export type AgentsListQuery = { __typename?: 'Query', agents: Array<{ __typename?: 'Agent', id: string, name: string, slug?: string | null, role?: string | null, type: AgentType, status: AgentStatus, runtime: AgentRuntime, templateId: string, avatarUrl?: string | null, createdAt: any, agentTemplate?: { __typename?: 'AgentTemplate', id: string, name: string, slug: string, model?: string | null } | null }>, modelCatalog: Array<{ __typename?: 'ModelCatalogEntry', modelId: string, displayName: string }> };
