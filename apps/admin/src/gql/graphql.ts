...
export type TenantAgentQuery = { __typename?: 'Query', agent: { __typename?: 'Agent', id: string, tenantId: string, name: string, slug?: string | null, role?: string | null, type: AgentType, status: AgentStatus, runtime: AgentRuntime, model?: string | null, budgetMonthlyCents?: number | null, systemPrompt?: string | null, avatarUrl?: string | null, lastHeartbeatAt?: any | null, runtimeConfig?: any | null, adapterType?: string | null, adapterConfig?: any | null, humanPairId?: string | null, version: number, parentAgentId?: string | null, createdAt: any, updatedAt: any, humanPair?: { __typename?: 'User', id: string, name?: string | null, email: string } | null, capabilities: Array<{ __typename?: 'AgentCapability', id: string, capability: string, config?: any | null, enabled: boolean }>, skills: Array<{ __typename?: 'AgentSkill', id: string, skillId: string, enabled: boolean, config?: any | null, permissions?: any | null }>, budgetPolicy?: { __typename?: 'AgentBudgetPolicy', id: string, limitUsd: number, actionOnExceed: string, enabled: boolean } | null, subAgents?: Array<{ __typename?: 'Agent', id: string, name: string, slug?: string | null, role?: string | null, status: AgentStatus }> | null } };
