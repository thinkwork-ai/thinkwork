...
export type RoutinesListQuery = { __typename?: 'Query', routines: Array<{ __typename?: 'Routine', id: string, name: string, description?: string | null, type: string, status: string, schedule?: string | null, lastRunAt?: any | null, nextRunAt?: any | null, agentId?: string | null, engine: string, createdAt: any, agent?: { __typename?: 'Agent', id: string, name: string } | null }> };
