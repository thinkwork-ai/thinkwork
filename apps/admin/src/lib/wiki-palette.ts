/**
 * Canonical palette for compiled wiki pages. Single source of truth so
 * the Wiki list badge, the graph legend, and the force-graph sphere all
 * show the same color for the same page type.
 *
 * Entity → blue, Topic → purple, Decision → yellow (matches the
 * existing Hindsight "Summaries" badge tone so the family visual
