...
export function listMcpServers(
  ...
  return apiFetch(`/api/skills/agent/${agentId}/mcp-servers`);
}
...
export function removeMcpServer(
  ...
  return apiFetch(`/api/skills/agent/${agentId}/mcp-servers/${serverId}`, {
    method: "DELETE",
  });
}
...
export function testMcpServer(
  ...
  return apiFetch(`/api/skills/agent/${agentId}/mcp-servers/${serverId}/test`, {
    method: "POST",
  });
}
