...
function SkillRunDetailPage() {
  ...
  setBreadcrumbs([
    { label: "Skill Runs", href: "/skill-runs" },
  ...
  const handleDelete = async () => {
    ...
    navigate({ to: "/skill-runs", search: { skillId: undefined, status: undefined, invocationSource: undefined } });
  };
  ...
  if (!run) {
    return (
      <div className="p-8">
        <Button variant="ghost" onClick={() => navigate({ to: "/skill-runs", search: { skillId: undefined, status: undefined, invocationSource: undefined } })}>
