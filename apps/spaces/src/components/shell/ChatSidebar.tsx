  ...
  return (
    <Collapsible defaultOpen={defaultOpen} className="group/thread-section">
      <CollapsibleTrigger asChild>
        <SidebarGroupLabel
          asChild
          className="cursor-pointer select-none gap-1.5 px-2 text-xs font-medium text-sidebar-foreground/50 data-[state=open]:text-sidebar-foreground/70"
        >
          <button type="button" aria-label={`Toggle ${label}`}>
            <span>{label}</span>
            <ChevronDown className="ml-auto h-4 w-4 opacity-0 transition-[opacity,transform] group-hover/thread-section:opacity-100 group-focus-within/thread-section:opacity-100 group-data-[state=closed]/thread-section:-rotate-90" />
          </button>
        </SidebarGroupLabel>
      </CollapsibleTrigger>
      <CollapsibleContent>
      ...
      <div className="flex items-center gap-1">
        <CollapsibleTrigger asChild>
          <SidebarGroupLabel
            asChild
            className={cn(
              "w-auto min-w-0 cursor-pointer select-none gap-1.5 px-2 text-xs font-medium text-sidebar-foreground/50 data-[state=open]:text-sidebar-foreground/60",
          ...
          >
            <button type="button" aria-label={`Toggle ${label}`}>
              ...
              <ChevronDown className="h-4 w-4 shrink-0 opacity-0 transition-[opacity,transform] group-hover/space:opacity-100 group-focus-within/space:opacity-100 group-data-[state=closed]/space:-rotate-90" />
            </button>
          </SidebarGroupLabel>
        </CollapsibleTrigger>
      </div>
