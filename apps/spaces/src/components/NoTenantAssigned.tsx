...
/**
 * Rendered when the signed-in user has no tenant assignment. apps/spaces
  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center gap-4 px-6 py-12">
      ...
      <p className="max-w-md text-center text-sm text-muted-foreground">
        Your account ({user?.email ?? "signed-in user"}) is not yet a member of
        any ThinkWork tenant. Ask your tenant operator to invite you, then sign
        in again.
      </p>
