# Workbench Layout Notes

- Workbench routes keep the global sidebar visible so users can move between Spaces, new threads, apps, approvals, memory, and thread history without losing context.
...
- Composition decisions stay inside `apps/spaces`; shared primitives remain in `@thinkwork/ui`.
