...
export type SettingsSpaceQuery = { __typename?: 'Query', space?: { __typename?: 'Space', id: string, tenantId: string, name: string, description?: string | null, status: SpaceStatus, accessMode: SpaceAccessMode, slug: string } | null };
