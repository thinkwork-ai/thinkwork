...
```bash
SMOKE_ENABLE_AGENT_APPLET_PROMPT=1 scripts/smoke-spaces.sh dev
```
...
```bash
SMOKE_BROWSER_SCENARIO=1 SMOKE_REQUIRE_BROWSER_EVIDENCE=1 scripts/smoke-spaces.sh dev
```
...
```bash
SMOKE_BROWSER_SCENARIO=1 SMOKE_REQUIRE_BROWSER_EVIDENCE=1 SMOKE_REQUIRE_BROWSER_COMPLETED=1 scripts/smoke-spaces.sh dev
```
