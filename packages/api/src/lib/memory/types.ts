 ...
 * passing through a {@link MemoryAdapter}. Raw backend/database internals
 * stay encapsulated by the adapter.
 *
 * Defined per `.prds/memory-implementation-plan.md` §8–9.
 */

export type MemoryEngineType = "agentcore";
 ...
 * (semantic / preferences / summaries / episodes). This keeps the runtime
