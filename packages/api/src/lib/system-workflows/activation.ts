...
export type ActivationSystemWorkflowContext = {
  tenantId: string;
  runId: string;
  executionArn?: string | null;
};

export async function recordActivationWorkflowStep(
  context: ActivationSystemWorkflowContext | null | undefined,
  input: {
    nodeId: string;
    stepType: string;
    status: string;
...
export async function recordActivationWorkflowEvidence(
  context: ActivationSystemWorkflowContext | null | undefined,
  input: {
    evidenceType: string;
    title: string;
...
export async function updateActivationWorkflowRunSummary(
  context: ActivationSystemWorkflowContext | null | undefined,
