...
describe("runDocumentPreflight", () => {
  ...
  // ---- Plate retirement (THINK-154) ---------------------------------------
  it("does not enforce plate markers — compositor output is plate-conformant by construction", () => {
    // VALID_DOC carries no tw-plate marker; with the PLATE gate retired it
    // passes on structural checks alone.
