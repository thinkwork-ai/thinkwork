...
const THREAD_DEFAULTS = [
  {
    ...
    prompt: "Check my emails and summarize what's new",
  },
  {
    title: "Check opportunities",
    prompt: "List the last 5 opportunities in CRM",
  },
  {
    title: "Check restaurant availability",
    prompt: "Check the restaurant availability at ",
  },
  {
    title: "Find a restaurant",
    prompt: "Search for restaurants and return availability in the ",
  },
  {
    title: "Schedule a meeting",
    prompt: "Schedule a meeting with the team tomorrow",
  },
  {
    title: "Review my calendar",
    prompt: "Review my calendar for conflicts this week",
  },
  {
    title: "Things to do with kids",
    prompt:
      "Search for things to do in Austin, TX with kids during the next 3 days. Since we live in Austin, highlight unique or limited experiences, not just things a visitor would be interested in.",
  },
  {
    title: "Summarize recent deals",
    prompt:
      "Summarize the status of all deals that changed stage in the last 7 days",
  },
  {
    title: "Draft a follow-up email",
    prompt:
      "Draft a follow-up email to my most recent meeting attendees thanking them and summarizing action items",
  },
  {
    title: "Research a company",
    prompt:
      "Research Border Tire and give me a brief company overview, recent news, and key contacts",
  },
  {
    title: "Plan my week",
    prompt:
      "Look at my calendar and tasks for this week and suggest a prioritized daily plan",
  },
];
...
const TASK_DEFAULTS = [
  {
    ...
    prompt:
      "Review my open tasks and suggest what I should work on today, in priority order.",
  },
  {
    title: "Follow up on stale tasks",
    prompt:
      "List tasks I haven't touched in more than 3 days and draft follow-ups.",
  },
  {
    title: "Summarize open tasks",
    prompt:
      "Give me a one-paragraph summary of my open tasks grouped by status.",
  },
];

export const userQuickActions_ = async (
  _parent: any,
  args: any,
  ctx: GraphQLContext,
) => {
  const { tenantId, scope: rawScope } = args as {
    tenantId: string;
    scope?: string | null;
  };
