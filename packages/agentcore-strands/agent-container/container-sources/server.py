...
def _call_strands_agent(system_prompt: str, messages: list,
    ...
    if context_engine_enabled:
        try:
            ...
            tools.extend(
                make_context_engine_tools(
                    _context_engine_tool_decorator,
...
def _execute_agent_turn(payload: dict) -> dict:
    ...
    context_engine_config = payload.get("context_engine_config")
    if not isinstance(context_engine_config, dict):
