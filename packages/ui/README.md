...
Shared visual primitives, theme tokens, and design utilities for ThinkWork's web apps. Owns the look and feel; does not own routing, GraphQL, auth, or app-specific composition — those stay in each consumer (`apps/web`, `apps/mobile`).
