...
export interface BrowserAutomationRunnerOptions {
...
export async function runAgentCoreBrowserAutomation(
  options: BrowserAutomationRunnerOptions,
  ...
  const url = validHttpUrl(request.url);
