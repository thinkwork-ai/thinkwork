/**
 * AWS RDS global CA trust bundle (https://truststore.pki.rds.amazonaws.com/global/global-bundle.pem).
 *
 * Embedded as a TS constant so the esbuild single-file Lambda bundle
 * carries it without a filesystem asset copy (THINK-229 U1 / R3: the
 * broker connects to Aurora with rejectUnauthorized: true against this
 * bundle instead of sslmode=no-verify). Public certificate material —
 * safe to commit. Refresh: curl the URL above and regenerate this file
 * (see scripts/update-rds-ca-bundle.sh).
 */
