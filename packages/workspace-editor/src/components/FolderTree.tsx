...
import type { WorkspaceFileSource } from "../lib/workspace-files-client.js";
...
export function buildWorkspaceTree(
  ...
  // Ensure reserved root folders always appear in the tree even when no
  // files exist under them yet.
...
export interface FolderTreeProps {
  ...
  sourceFor: (path: string) => WorkspaceFileSource | undefined;
