...
branches), daily scheduling cadence, and the `renewal_risk` package
template. A good file to read right after the other two to see how the
DSL parameterizes shape vs substance.
