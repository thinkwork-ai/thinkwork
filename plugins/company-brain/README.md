...
This package currently owns the catalog manifest while the internal Cognee
deployment adapter, Terraform, and parity test source remains in legacy shared
locations until later migration units move them behind the same plugin boundary.
