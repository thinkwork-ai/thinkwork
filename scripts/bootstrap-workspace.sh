#!/usr/bin/env bash
# Bootstrap workspace default files for a Thinkwork stage.
#
# Uploads the canonical workspace templates, then copies defaults to any
# existing templates that are missing workspace files.
#
# Usage:
