...
output "plane_runtime_enabled" {
  description = "Whether Plane ECS services are configured to run"
  value       = local.plane_runtime_enabled
}

output "plane_url" {
  description = "Public Plane URL (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_url : null
}

output "plane_alb_dns_name" {
  description = "Public ALB DNS name for Plane (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_alb_dns_name : null
}

output "plane_alb_arn" {
  description = "Public ALB ARN for Plane (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_alb_arn : null
}

output "plane_target_group_arn" {
  description = "Target group ARN for Plane web service (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_target_group_arn : null
}

output "plane_cluster_arn" {
  description = "ECS cluster ARN for Plane (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_cluster_arn : null
}

output "plane_web_service_name" {
  description = "ECS service name for Plane web (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_web_service_name : null
}

output "plane_api_service_name" {
  description = "ECS service name for Plane API (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_api_service_name : null
}

output "plane_worker_service_name" {
  description = "ECS service name for Plane worker (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_worker_service_name : null
}

output "plane_beat_worker_service_name" {
  description = "ECS service name for Plane beat worker (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_beat_worker_service_name : null
}

output "plane_live_service_name" {
  description = "ECS service name for Plane live (null when plane_provisioned = false)"
...
output "plane_api_log_group_name" {
  description = "CloudWatch log group for Plane API (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_api_log_group_name : null
}

output "plane_worker_log_group_name" {
  description = "CloudWatch log group for Plane worker (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_worker_log_group_name : null
}

output "plane_beat_worker_log_group_name" {
  description = "CloudWatch log group for Plane beat worker (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_beat_worker_log_group_name : null
}

output "plane_live_log_group_name" {
  description = "CloudWatch log group for Plane live (null when plane_provisioned = false)"
...
output "plane_storage_bucket_name" {
  description = "S3 bucket name used for Plane uploads (null when plane_provisioned = false)"
  value       = local.plane_provisioned ? module.plane[0].plane_storage_bucket_name : null
}
