...
superseded_by: docs/brainstorms/2026-05-12-computer-artifact-shadcn-vocabulary-and-mcp-requirements.md
---

> **Superseded on 2026-05-12** by the follow-up brainstorm [`docs/brainstorms/2026-05-12-computer-artifact-shadcn-vocabulary-and-mcp-requirements.md`](../brainstorms/2026-05-12-computer-artifact-shadcn-vocabulary-and-mcp-requirements.md). The TSX runtime is no longer being killed; the HTML payload kind is rejected; the three-component registry idea is dropped in favor of constraining the existing TSX authoring vocabulary to shadcn primitives plus a shadcn MCP catalog. **Do not implement against this plan.** Run `ce-plan` fresh against the new brainstorm.
