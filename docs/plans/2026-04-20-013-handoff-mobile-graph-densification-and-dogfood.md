...
```bash
export DATABASE_URL="postgresql://thinkwork_admin:ThinkworkDev2026%21@thinkwork-dev-db.cluster-cmfgkg8u8sgf.us-east-1.rds.amazonaws.com:5432/thinkwork?sslmode=require"
...
```
DATABASE_URL="postgresql://thinkwork_admin:ThinkworkDev2026%21@thinkwork-dev-db.cluster-cmfgkg8u8sgf.us-east-1.rds.amazonaws.com:5432/thinkwork?sslmode=require"
```
