...
Plan: `docs/plans/2026-06-14-004-feat-brain-remaining-substrate-plan.md`
Status doc created: 2026-06-14

## Current Status

- THNK-15, the ThinkWork Brain premium plugin shell blocker, is Done.
...
- Fetched THNK-6 attachment:
  - `2026-06-13-003-feat-brain-physical-substrate-plan.md.gz`
- Fetched project `Enterprise Agent OS` and milestone `ThinkWork Brain dogfood
proof`, which is 100% complete.
- Fetched ThinkWork team statuses; `In Progress`, `Verification`, and `Done`
  are available.
- Searched the repo for THNK-6, ThinkWork Brain, ThinkWork Brain, physical
...
- Read current code seams for substrate status, migration tables, Context
  Engine Brain provider, and ThinkWork Brain plugin detail.
- Checked referenced external docs for the retired graph substrate storage/provider posture and AWS
  Neptune/OpenSearch cost/storage facts.

## Important Context

- ThinkWork Brain is the customer-facing product. the retired graph substrate is internal substrate
  machinery and should not be surfaced as a product, plugin, license,
  install option, or storage choice.
- Hindsight remains episodic memory; ThinkWork Brain owns governed graph/vault
...
- First-party agents use Context Engine / `query_brain_context`; raw the retired graph substrate,
...
- 2026-06-14: Implemented U4 API/domain migration orchestration:
  `requestBrainProductionMigration` and `updateBrainMigration`
  GraphQL mutations, a tested ThinkWork Brain migration domain helper, resolver
...
- 2026-06-14: U4 codegen note: CLI and mobile generated types also picked up
  ...
  output only changed for the new ThinkWork Brain migration mutations.
- 2026-06-14: U4 local verification passed:
  `pnpm --filter @thinkwork/api exec vitest run src/lib/brain/migration.test.ts src/graphql/resolvers/brain/brainMigration.mutation.test.ts src/graphql/resolvers/brain/brainStatus.query.test.ts`,
...
- 2026-06-14: Implemented U5b migration-aware Brain reads in the ThinkWork Brain
...
- 2026-06-14: U5b verification passed:
  `pnpm --filter @thinkwork/api exec vitest run src/lib/context-engine/providers/brain.test.ts`,
  `pnpm --filter @thinkwork/api typecheck`, and
...
- 2026-06-14: Opened U5b PR
  ...
  migration-aware ThinkWork Brain Context Engine reads.
...
- 2026-06-14: Implemented U6 Brain operations UI:
  operator-guarded `/settings/brain-operations` route, ThinkWork Brain plugin
...
- 2026-06-14: Implemented U7 docs/smoke closure:
  `brain-operations-smoke.mjs` dry-run/read-only live smoke with
...
- 2026-06-14: U7 smoke verification passed:
  `node --check plugins/brain/smoke/brain-operations-smoke.mjs`,
  `node --check plugins/brain/smoke/brain-context-engine-smoke.mjs`,
...
- Desired next Linear update from dispatcher for U7 PR:
  "Opened U7 PR for ThinkWork Brain documentation and smoke closure:
