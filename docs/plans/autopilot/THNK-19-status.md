...
Linear issue: THNK-19 — U3: Add canonical ThinkWork Brain S3 artifacts and manifests
Target branch: `main`
...
- THNK-15, the ThinkWork Brain plugin shell prerequisite, is `Done`.
...
- Linear attachment:
  - `2026-06-13-003-feat-brain-physical-substrate-plan.md.gz`, exact export of `docs/plans/2026-06-13-003-feat-brain-physical-substrate-plan.md`
...
Primary CE plan: `docs/plans/2026-06-14-001-feat-brain-artifact-manifests-plan.md`
...
- 2026-06-14: Searched repo for THNK-19, issue title, referenced plan filenames, ThinkWork Brain artifact wording, source artifacts, replayable manifests, and wiki export references.
...
- 2026-06-14: Extended existing `brain.artifact_manifests` with Knowledge Graph ingest-run linkage, source/runtime metadata, source ids, object version/content metadata, ontology mechanism, and JSON metadata via manual migration `0167_brain_artifact_manifest_runtime.sql`.
...
- 2026-06-14: Focused database tests passed: `pnpm --filter @thinkwork/database-pg exec vitest run __tests__/migration-0167-brain-artifact-manifests.test.ts __tests__/migration-0166-brain-substrate.test.ts __tests__/knowledge-graph-schema.test.ts`.
...
- Use `docs/plans/2026-06-13-003-feat-brain-physical-substrate-plan.md` as the primary upstream CE plan.
