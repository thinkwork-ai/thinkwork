...
| U2 GitHub Import and Verification Pipeline                   | in_progress | `codex/think-114-u2-github-import-verification` |                                                              | Add GitHub import, manifest parsing, verification, artifact evidence.  |
