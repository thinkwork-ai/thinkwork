...
| U2 GitHub Import and Verification Pipeline                   | in_progress | `codex/think-114-u2-github-import-verification` | [#3143](https://github.com/thinkwork-ai/thinkwork/pull/3143) | Add GitHub import, manifest parsing, verification, artifact evidence.  |
