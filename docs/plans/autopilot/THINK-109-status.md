...
| U5 plugin app overlay persistence                   | PR open | `codex/think-109-u5-plugin-app-overlay-state` | [#3113](https://github.com/thinkwork-ai/thinkwork/pull/3113) | Adds durable ThinkWork-owned overlay state for plugin app records. |
