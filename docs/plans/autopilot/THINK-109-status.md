...
| --------------------------------------------------- | ------- | ----------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| U1 ui-surface launch contract                       | PR open | `codex/think-109-u1-app-surface-contract` | [#3107](https://github.com/thinkwork-ai/thinkwork/pull/3107) | Adds launch metadata validation and Twenty Client Engagement manifest surface; also carries planning/autopilot docs because they were not already on `main`. |
| U2 installed plugin app discovery                   | pending |                                           |                                                              | Depends on U1.                                                                                                                                               |
