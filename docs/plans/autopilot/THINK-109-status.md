...
| U4 Twenty engagement CRM data API                   | PR open | `codex/think-109-u4-twenty-engagement-api`   | [#3111](https://github.com/thinkwork-ai/thinkwork/pull/3111) | Adds app-specific Twenty engagement query/mutations.              |
