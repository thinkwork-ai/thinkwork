...
Issue: THNK-23 - Expose ThinkWork Brain as a first-party agent context tool
Branch: `codex/thnk-23-brain-first-party-tool`
Plan: `docs/plans/2026-06-14-005-feat-brain-first-party-tool-plan.md`
...
- 2026-06-14: Searched repo for `THNK-23`, `THNK-6`, `ThinkWork Brain`, `first-party agent context`, and `query_brain_context`.
...
- 2026-06-14: Created branch `codex/thnk-23-brain-first-party-tool` from `origin/main`.
...
- 2026-06-14: Implemented all planned units on `codex/thnk-23-brain-first-party-tool`.
...
- 2026-06-14: Committed implementation as `cdf021ef9` (`feat: expose ThinkWork Brain context tool`) and pushed branch `codex/thnk-23-brain-first-party-tool`.
...
- THNK-6/THNK-20 context keeps raw the retired graph substrate, Neptune, S3, storage, and ontology admin APIs internal behind Context Engine.
...
- ThinkWork Brain plugin install remains provider eligibility only; runtime tool registration stays gated by existing `context_engine_enabled` policy.
