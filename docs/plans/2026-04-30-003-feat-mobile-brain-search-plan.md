---
title: "feat: Mobile ThinkWork Brain search and enrichment"
type: feat
status: active
date: 2026-04-30
origin:
...
# feat: Mobile ThinkWork Brain search and enrichment

## Overview

Mobile should move from a page-first Wiki surface to a search-first ThinkWork Brain surface. The tab should help a user ask the Brain, inspect cited results across approved sources, browse pages/graph when that is the right mode, and turn useful findings into reviewed durable context for future automated agents.
...
The current mobile tab is still labeled and shaped as Wiki: a segmented `Threads | Wiki` control, a recent page list, graph entry point, and `Search wiki...` footer. That was right when the feature was compiled page browse. It is too narrow for the ThinkWork Brain direction now taking shape in admin and the API.
...
- R1-R6. Rename/reframe the mobile Wiki surface as Brain, make unified ThinkWork Brain search primary, show citations and provider health, keep Pages and graph as modes, and expose page-oriented result actions.
...
- `packages/api/src/lib/context-engine/providers/wiki.ts` adapts compiled page search as "ThinkWork Brain Pages."
