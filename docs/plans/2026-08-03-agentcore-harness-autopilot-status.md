...
- **U2/U3 wrap-up → U5 — runtime provisioning hardening (THINK-584)**
- U2 code fully merged (#4165, #4167, #4169); awaiting post-deploy re-measure + Eric's UI validation at localhost:5174.
- U3 (#4168) auto-merge armed pending CI; then deploy + PC READY verification.
- Status: In progress
