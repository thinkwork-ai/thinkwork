...
- Status: Active
- Active unit: U3 desktop IPC contract complete; review/PR pending
- Active branch: `codex/desktop-u3-ipc`
- Active worktree: `.Codex/worktrees/desktop-u3-ipc`
- Started: 2026-05-21
- PR: pending for U3
- CI: local pre-PR verification complete
