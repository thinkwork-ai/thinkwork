...
- Active PR: none
- CI: not started for U8; local verification passed
...
| 2026-05-28 | U8   | `codex/local-pi-u8-diagnostics`         | pending                                                      | Ready for PR | Local passed | Diagnostics, redaction, packaging, rollout.    |
