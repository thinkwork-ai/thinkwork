...
- Target branch: `main`.
- Current unit: U17 Desktop Pi quota-aware diagnostic sweep.
- Current branch: `codex/desktop-pi-evals-u17-diagnostic-sweep`.
- Current worktree: `.Codex/worktrees/desktop-pi-evals-u17-diagnostic-sweep`.
