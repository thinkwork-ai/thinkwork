...
| 2026-05-19 | U3   | `codex/spaces-chat-u3-inbox-summaries`      | pending                                                      | In progress | `pnpm install`; `pnpm schema:build`; CLI/admin/mobile codegen; focused API/computer tests; `pnpm --filter @thinkwork/api typecheck`; `pnpm --filter @thinkwork/computer typecheck`; `pnpm -r --if-present lint`; `pnpm -r --if-present typecheck`; `pnpm -r --if-present test`                                                                                                                                                                                                                                                                                                     | Adding GraphQL data support for global unread Inbox rows, per-Space unread counts, and Space activity summaries.                                                                                                                                                                               |
