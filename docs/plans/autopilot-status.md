...
- Active PR: none
- CI: U2 local verification passed
...
| 2026-05-27 | U2   | `codex/goals-u2-storage` | TBD                                                          | Local passed | API/repo checks passed | Thread Goal file storage and prompt wrapper.              |
