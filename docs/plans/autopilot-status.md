...
- Active unit: U10 - suppress legacy wiki graph writers under active ontology
- Active branch: `codex/wiki-ontology-legacy-link-suppression`
- Active worktree: `.Codex/worktrees/wiki-ontology-legacy-link-suppression`
- Started: 2026-05-19
- PR: pending
- CI: pending
...
| 2026-05-19 | U10  | `codex/wiki-ontology-legacy-link-suppression` | Pending                                                      | In progress | `pnpm install --frozen-lockfile`; `pnpm --filter @thinkwork/api test -- src/__tests__/wiki-compiler.test.ts src/lib/wiki/repository.test.ts`; `pnpm --filter @thinkwork/api typecheck`; `git diff --check`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Live rebuild after U9 deployed proved remaining bypasses: active ontology compiles still allowed legacy aggregation/deterministic graph writers to create generic `topic` pages and `reference`/`parent_of`/`child_of` links. Suppressing those legacy writers while an active ontology is present. |
