---
title: Changelog
description: "Chronological table of every compliance PR with merged dates, sub-unit, capability summary, and deploy-to-dev / deploy-to-prod columns."
---
...
| [#911](https://github.com/thinkwork-ai/thinkwork/pull/911) | 2026-05-07  | U6      | Runtime audit emit path (REST `POST /api/compliance/events` + idempotency on UUIDv7 event_id)                                              | (next deploy) | (pending prod deploy) |
