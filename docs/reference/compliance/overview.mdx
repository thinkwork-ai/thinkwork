...
- Captures audit events at every emit site (Yoga resolvers + runtime REST callers) inside the originating transaction (control-evidence) or out-of-band (telemetry).
...
| U6   | Runtime audit emit path (REST + runtime client)                                                          | [#911](https://github.com/thinkwork-ai/thinkwork/pull/911)                                                                                                                                                                                     | 2026-05-07 |
