...
flowchart LR
  subgraph Emit
    ...
    S[AgentCore runtime<br/>REST emit]
...
| Runtime REST emit        | AgentCore runtime callers + [`packages/api/src/handlers/compliance.ts`](https://github.com/thinkwork-ai/thinkwork/blob/main/packages/api/src/handlers/compliance.ts)                                                                                                                                       |
...
| Web app                | [`apps/web/src/routes/_authed/_tenant/compliance/`](https://github.com/thinkwork-ai/thinkwork/tree/main/apps/web/src/routes/_authed/_tenant/compliance) + [`components/compliance/`](https://github.com/thinkwork-ai/thinkwork/tree/main/apps/web/src/components/compliance)                         |
