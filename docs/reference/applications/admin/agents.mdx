...
- Tools, MCP servers, memory, and triggers.
...
- [Admin — Spaces](/applications/admin/spaces/) — Space Studio overview, list, Workspace, Sources, Triggers, Settings, and Members
