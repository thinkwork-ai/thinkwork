...
| Symphony Linear tracker connector (Computer-first pickup + PR writeback) | Beta   |
...
2. **Connector platform expansion** — Linear is the current proof; future connector ordering is still being planned
