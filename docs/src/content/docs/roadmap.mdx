...
ThinkWork v1 is a working, production-deployable Agent Harness. It is not a finished product. This page is honest about what's in scope for v1 across all three deployment tiers (ThinkWork open / ThinkWork for Business / ThinkWork Enterprise), what's explicitly out of scope, and what the roadmap looks like. The harness mechanics — PPAF agent loop, REST anchors, six-component model — are stable; what continues to evolve is the depth of each component.
