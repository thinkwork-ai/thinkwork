...
<Aside type="note">
"Beta" means the feature works and is deployed in production by early users, but the API or configuration interface may change before v1.0 is declared stable.
</Aside>
...
2. **Computer runtime hardening** — CLI/tool install, stronger isolation, runtime reconciliation, browser/computer-use path
3. **Cost tracking** — Aggregated cost reports by tenant, Computer, Agent, and time period
