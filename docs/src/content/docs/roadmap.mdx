...
1. **Admin runtime selector** — Operator-facing Strands/Pi selection on agents and templates
...
6. **Eval agent with browser automation** — Nova Act or similar for UI-driven agent tests
