...
External memory sources (Twenty CRM, Firecrawl web, Gmail, Bedrock KB documents — see the [concept overview](/concepts/knowledge/compounding-memory/#external-memory-sources-think-193)) roll out per tenant through **independent gates**, in this order:
