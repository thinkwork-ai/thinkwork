...
description: Programmatic access to compiled Memory pages — reading pages, searching, compiling on demand, and bulk-importing.
---
...
- [Memory Compile Pipeline](/concepts/knowledge/compounding-memory-pipeline/) — what compiles do
