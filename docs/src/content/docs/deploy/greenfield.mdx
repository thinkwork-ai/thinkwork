...
- Bedrock AgentCore Memory (durable agent memory: retain, recall, episodes)
...
5. **Edit terraform.tfvars**
   ...
   # Memory needs no configuration — Bedrock AgentCore Memory is the only
   # engine and is always on.
