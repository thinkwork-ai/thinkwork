...
- managed-app descriptors for Twenty and n8n
- smoke contracts
...
publisher builds ThinkWork-owned application images for managed app deployments
and reads pinned Twenty and n8n image URIs from repository
