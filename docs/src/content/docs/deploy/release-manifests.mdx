...
| ----------- | ---------------------- | -------------------------------------------- |
| Cognee      | `cognee`               | `scripts/smoke/cognee-managed-app-smoke.mjs` |
| Twenty CRM  | `twenty`               | `scripts/smoke/twenty-managed-app-smoke.mjs` |
| Plane       | `plane`                | `scripts/smoke/plane-managed-app-smoke.mjs`  |
