...
publisher builds the ThinkWork-owned Cognee image and reads pinned Twenty/Kestra
...
The TEI proving environment accepted `v0.1.0-canary.148` under the explicit
`allow_unsigned_canary` trust policy. Evidence records both the raw manifest
SHA-256
`5b154f800b8754d00d0b252772005bd02fc1dbbf6096036597efd700d4d6df93` and the
