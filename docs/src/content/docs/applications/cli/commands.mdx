...
| 2 — Agents & workspace        | ✅ [`member`](#member), [`team`](#team), [`kb`](#kb), [`template`](#template), [`tenant`](#tenant), [`agent`](#agent) — **Phase 2 complete**                                                                                        |
| 3 — Automation & integrations | ✅ [`routine`](#routine), [`scheduled-job`](#scheduled-job), [`turn`](#turn), [`wakeup`](#wakeup), [`webhook`](#webhook), [`skill`](#skill) — **Phase 3 complete**. Run `thinkwork <cmd> --help` for the full subcommand reference. |
| 4 — Memory & artifacts        | ✅ [`memory`](#memory), [`recipe`](#recipe), [`artifact`](#artifact) — **Phase 4 complete**. Run `thinkwork <cmd> --help` for the full subcommand reference.                                                                        |
| 5 — Observability & spend     | ✅ [`cost`](#cost), [`budget`](#budget), [`performance`](#performance), [`trace`](#trace), [`dashboard`](#dashboard) — **Phase 5 complete**. Run `thinkwork <cmd> --help` for the full subcommand reference.                        |
