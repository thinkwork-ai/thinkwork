...
- [Tenant Agent](/applications/admin/agents/) — tenant-wide platform-agent defaults, workspace, and sub-agent folders.
- [Spaces](/applications/admin/spaces/) — Space workspace, tools, memory, automations, email triggers, and runtime overrides.
...
Do not use retired subcommands for new automation. Space email is configured from [Admin — Spaces](/applications/admin/spaces/), not through `thinkwork agent email`.
