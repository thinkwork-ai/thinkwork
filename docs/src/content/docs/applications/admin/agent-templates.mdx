...
description: Reusable agent configuration bundles - runtime, model, built-in tool opt-ins, workspace files, MCP servers, guardrails - plus the explicit sync flow that propagates changes out to linked agents.
---
