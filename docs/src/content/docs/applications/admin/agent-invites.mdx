...
3. Also revoke the API key through the credential vault (see [Connectors](/applications/admin/connectors/) for credential rotation)
...
- [Connectors](/applications/admin/connectors/) — credential vault and API key management
