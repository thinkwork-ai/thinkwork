...
- [Tenant Agent](/applications/admin/agents/) — the platform agent that runs managed turns
- [Spaces](/applications/admin/spaces/) — the workrooms that scope thread context
