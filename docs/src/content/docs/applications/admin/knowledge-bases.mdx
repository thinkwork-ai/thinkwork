...
Knowledge Bases are Bedrock Knowledge Bases backed by Aurora `pgvector`. The Admin Memory page lets operators create knowledge bases, upload documents directly to their underlying S3 bucket, trigger Bedrock's ingestion job, and watch sync status without leaving the app.
...
- [Admin — Memory](/applications/admin/knowledge/) — the combined Admin surface for Memory, Pages, Knowledge Bases, and Sources
