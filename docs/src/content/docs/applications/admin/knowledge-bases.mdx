...
Knowledge Bases are Bedrock Knowledge Bases backed by Aurora `pgvector`. The Admin Knowledge page lets operators create knowledge bases, upload documents directly to their underlying S3 bucket, trigger Bedrock's ingestion job, and watch sync status without leaving the app.

## The list view

**Route:** `/knowledge/knowledge-bases`
**Route wrapper:** `apps/admin/src/routes/_authed/_tenant/knowledge/knowledge-bases.tsx`
**Tab implementation:** `apps/admin/src/routes/_authed/_tenant/knowledge-bases/index.tsx`

The legacy `/knowledge-bases` route redirects to this tab.
...
**Route:** `/knowledge/knowledge-bases/:kbId`
**Route wrapper:** `apps/admin/src/routes/_authed/_tenant/knowledge/knowledge-bases/$kbId.tsx`
**Detail implementation:** `apps/admin/src/routes/_authed/_tenant/knowledge-bases/$kbId.tsx`
...
- [Memory](/applications/admin/memory/) — the Memory tab behavior: stateful memory vs stateless documents
