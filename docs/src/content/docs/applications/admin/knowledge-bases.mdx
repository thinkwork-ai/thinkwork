...
**Route wrapper:** `apps/web/src/routes/_authed/_tenant/knowledge/knowledge-bases.tsx`
**Tab implementation:** `apps/web/src/routes/_authed/_tenant/knowledge-bases/index.tsx`
...
**Route wrapper:** `apps/web/src/routes/_authed/_tenant/knowledge/knowledge-bases/$kbId.tsx`
**Detail implementation:** `apps/web/src/routes/_authed/_tenant/knowledge-bases/$kbId.tsx`
...
- [Admin — Memory](/applications/web/knowledge/) — the combined Admin surface for Memory, Pages, Knowledge Bases, and Sources
- [Memory](/applications/web/memory/) — the Memory tab behavior: stateful memory vs stateless documents
