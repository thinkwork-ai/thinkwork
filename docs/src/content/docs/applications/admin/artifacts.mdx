...
**Route:** `/artifacts`  
**File:** `apps/web/src/routes/_authed/_tenant/artifacts/index.tsx`
...
- [Threads](/applications/web/threads/) — the source of every artifact; the thread detail page lists artifacts produced on that thread
- [Agents](/applications/web/agents/) — which agents produce which artifact types is a function of their tool policy
- [Automations (concept)](/concepts/automations/) — workflows can produce artifacts as their output
