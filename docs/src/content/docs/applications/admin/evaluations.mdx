...
![Evaluations dashboard](../../../../assets/admin-evaluations/dashboard.png)
...
![Run Evaluation dialog](../../../../assets/admin-evaluations/run-evaluation-dialog.png)
...
![Studio list](../../../../assets/admin-evaluations/studio-list.png)
...
![Test Case detail](../../../../assets/admin-evaluations/test-case-detail.png)
...
![Test Case editor](../../../../assets/admin-evaluations/test-case-editor.png)
...
![Run Results](../../../../assets/admin-evaluations/run-results.png)
...
![Result Detail Sheet](../../../../assets/admin-evaluations/result-detail-sheet.png)
...
The `reason` string is your friend. Look for the prefix: `LLM judge: ...` means the Bedrock judge ran and returned a verdict; `Heuristic rubric check ...` means Bedrock rejected the invoke and the keyword-fallback ran. If you see heuristic fallbacks across a run, check the `eval-runner` Lambda's IAM — see the [Architecture section](/guides/evaluations/#architecture) for the Bedrock access model.
</Aside>
...
- [Scheduled Jobs](/applications/admin/scheduled-jobs/) — the cron UI that powers eval schedules
