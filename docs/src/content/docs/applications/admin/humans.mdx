...
**Route:** `/humans`  
**File:** `apps/web/src/routes/_authed/_tenant/humans/index.tsx`
...
The Humans page only shows `user` rows. Service accounts are managed through [Agent Invites](/applications/web/agent-invites/) and the credential vault, not through Humans.
...
- [Settings](/applications/web/settings/) — tenant configuration, plan, and deployment status
- [Agent Invites](/applications/web/agent-invites/) — the BYOB equivalent for service accounts
- [Authentication & Tenancy](/applications/web/authentication-and-tenancy/) — how members authenticate into the admin app
