...
Optional infrastructure toggles such as Cognee and Twenty CRM live in
[Managed Applications](/applications/web/managed-applications/) inside
...
- [Managed Applications](/applications/web/managed-applications/) — optional Cognee and Twenty CRM deployment controls
