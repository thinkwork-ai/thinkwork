...
Optional infrastructure toggles such as Cognee, Twenty CRM, and n8n live in
...
- [Managed Applications](/applications/admin/managed-applications/) — optional Cognee, Twenty CRM, and n8n deployment controls
