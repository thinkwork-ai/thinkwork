...
- **Per-user OAuth or connector credentials** — those live in the mobile app. Admin owns tenant-wide infra and config; users own their own integration auth on mobile.
