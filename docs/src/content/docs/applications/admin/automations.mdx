...
- **Per-user OAuth or connector credentials** — those live in the mobile app per [user opt-in over admin config](/concepts/agents/) (admin owns infra config; users own integration auth).
