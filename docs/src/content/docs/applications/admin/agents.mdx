...
Knowledge base creation, document upload, and sync status live on the [Knowledge](/applications/admin/knowledge/) page's Knowledge Bases tab.
...
The Memory tab is a per-agent version of the tenant-wide [Knowledge](/applications/admin/knowledge/) page's Memory tab, scoped to this agent's namespace. Two view modes:
...
- [Knowledge](/applications/admin/knowledge/) — tenant-wide Memory, Wiki, Knowledge Bases, and Context Engine view
