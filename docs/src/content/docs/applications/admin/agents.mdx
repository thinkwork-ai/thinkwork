...
The Agents surface is where operators and authors build, configure, and iterate on delegated workers in a ThinkWork tenant. Computers are the primary per-user workspace/orchestrator surface; Agents are reusable managed workers that Computers, threads, automations, or operators can invoke for focused work.

For user-owned runtime state, persistent workspace files, and migration from old user-paired Agents, use [Admin — Computers](/applications/admin/computers/).
...
- [Computers](/applications/admin/computers/) — durable per-user workspace and runtime surface
