---
title: Admin — Agents
description: The agent roster plus workspace, runtime, template, Company Brain, and automation configuration. How to create, configure, and iterate on agents in the admin web app.
---

import { Aside } from '@astrojs/starlight/components';

The Agents surface is where operators and authors build, configure, and iterate on the agents running in a ThinkWork tenant. It covers the full agent lifecycle: listing the roster, creating new agents from templates, and opening each agent workspace/configuration view.
