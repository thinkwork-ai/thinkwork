...
- [Tenant Agent](/applications/admin/agents/) — configure platform-agent workspace and folder specialists
- [Spaces](/applications/admin/spaces/) — configure Space context that can produce review work
