...
<Aside type="note">
  ...
  network blip, and a fully quit app receives nothing until reopened. Your unread
  markers always reconcile when the app regains focus, so you won't lose track of
  a thread even if its notification didn't fire.
</Aside>
