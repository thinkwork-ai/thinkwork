...
mobile are clients. Strands is the default runtime; Pi is a parallel runtime
substrate that individual agents or templates can opt into. The surrounding
harness remains ThinkWork's either way. That distinction is important: managed
does not mean vendor-hosted.
