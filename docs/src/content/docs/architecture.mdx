...
| Resource               | Purpose                                                                                                                                                                            |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Aurora Postgres        | Primary data store: agents, threads, messages, AgentLoops, Workflows, integrations, users. Also hosts the `pgvector` index used by Bedrock Knowledge Bases — no separate vector DB |
