...
<CardGrid>
  ...
  <Card title="OKF Wiki Navigator" icon="open-book">
    A generated Open Knowledge Format projection that lets agents traverse
    compiled pages as read-only markdown evidence without bypassing Memory
    policy.
  </Card>
...
- [OKF Wiki Navigator](/concepts/knowledge/okf-wiki-navigator/) — generated markdown projection and read-only traversal
