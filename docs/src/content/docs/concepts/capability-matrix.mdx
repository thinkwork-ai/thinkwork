...
| Knowledge Bases         | `bound_knowledge_bases` in the invoke payload → Pi `search_knowledge` tool                                                                       | Direct agent/Space binding queries only (no tenant-wide fallback); tool assembles only when the payload carries at least one bound KB                                                                                                                                                                           |
