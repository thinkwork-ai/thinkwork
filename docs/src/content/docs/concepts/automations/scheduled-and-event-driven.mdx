...
State machines, rule patterns, and the EventBridge custom bus are provisioned by the ThinkWork Terraform module. For the operator view of schedules, see [Admin: Scheduled Jobs](/applications/admin/scheduled-jobs/).
