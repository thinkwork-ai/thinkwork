...
- Root `INSTRUCTIONS.md` routing (formerly `AGENTS.md`) and specialist folders.
...
The root `INSTRUCTIONS.md` (formerly `AGENTS.md`) is the routing map. A row such as this makes the specialist available:
...
| Root `INSTRUCTIONS.md`     | Routing, identity, folder map, and specialist ownership (formerly `AGENTS.md`)   |
