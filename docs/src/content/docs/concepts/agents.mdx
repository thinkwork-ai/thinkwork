...
Agents are the decision-making layer of Thinkwork. They sit on top of threads, use knowledge and memory for context, and call tools through skill packs or connectors.
