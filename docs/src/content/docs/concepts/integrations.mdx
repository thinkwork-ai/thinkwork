...
| ------------------------------------------------ | ---------------------------------------------------------------- |
| The tenant platform agent needs tools during work | MCP server or built-in skill/tool                               |
| A user needs provider OAuth                      | Mobile per-user connection flow                                  |
| A user-owned connector emits an event            | Connector trigger targeting a Space                              |
