...
description: How ThinkWork resolves tenant-agent defaults and Space runtime overrides for managed turns.
---
...
- **Space runtime overrides** on [Admin — Spaces](/applications/admin/spaces/).
...
- [Admin — Spaces](/applications/admin/spaces/) — Space overrides
