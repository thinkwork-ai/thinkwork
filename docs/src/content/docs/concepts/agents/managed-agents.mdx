...
- **Space-local behavior.** Context, tools, memory, automations, email triggers, and runtime overrides live where the work happens.
...
| Space        | Workspace files, tools, memory, automations, email trigger, runtime overrides |
