...
ThinkWork has always had durable Threads, Space context, folder-native agent behavior, and ThinkWork Brain. Goals connect those pieces into an operating system for repeatable work.
...
5. **Compound completed work.** Reviewed Goal folders become high-signal source material for ThinkWork Brain.
...
| ThinkWork Brain | Distilled reusable learning from reviewed source material                                                        | Completed work should improve future work without making raw Threads the only source. |
...
The finished folder then gives ThinkWork Brain a better source than scattered chat messages: it has the outcome, final progress, decisions, handoffs, artifacts, and provenance.
...
| ThinkWork Brain | Reviewed reusable knowledge distilled from completed work.                                           |
...
- Treat completed Goal folders as source material, not automatic truth. Let ThinkWork Brain distill them through provenance and review.
...
- [Compounding Memory Pipeline](/concepts/knowledge/compounding-memory-pipeline/) - how reviewed source material becomes ThinkWork Brain.
