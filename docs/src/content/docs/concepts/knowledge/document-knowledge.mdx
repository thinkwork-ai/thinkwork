...
description: How Memory uses authored documents — product docs, runbooks, policies — as retrievable context backed by Bedrock Knowledge Bases and pgvector.
---
...
- **Code path.** ThinkWork-side orchestration lives under `packages/api/src/`; the AgentCore-side retrieval integration lives in `packages/agentcore-pi/`.
