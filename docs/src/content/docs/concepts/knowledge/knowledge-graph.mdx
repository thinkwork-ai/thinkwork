---
title: Memory Graph Direction
description: What graph-shaped Memory data ThinkWork already ships and where typed-relationship semantics are headed next.
---
...
- [Compiled Memory Pages](/concepts/knowledge/compounding-memory/) — the overview of the page graph that's shipped today
- [Business Ontology](/concepts/knowledge/business-ontology/) — the governed vocabulary for typed business semantics
- [Memory Compile Pipeline](/concepts/knowledge/compounding-memory-pipeline/) — where `reference` and `parent_of` edges are written
- [Memory Page Model](/concepts/knowledge/compounding-memory-pages/) — the `wiki_page_links` data model
- [Operating Compiled Memory Pages](/guides/compounding-memory-operations/) — how to monitor link density + quality
