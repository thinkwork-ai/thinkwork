...
superseded_by: 2026-05-12-computer-artifact-shadcn-vocabulary-and-mcp-requirements.md
---

> **Superseded by [`2026-05-12-computer-artifact-shadcn-vocabulary-and-mcp-requirements.md`](./2026-05-12-computer-artifact-shadcn-vocabulary-and-mcp-requirements.md)** on 2026-05-12. The central decision below — kill the TSX runtime and introduce an HTML payload kind — was reversed in a follow-up brainstorm. The TSX runtime stays; the change is now constraining the authoring vocabulary to shadcn primitives and adding a shadcn MCP catalog. Do not feed this document to `ce-plan`.
