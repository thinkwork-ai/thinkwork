---
title: ThinkWork Brain migrations keep reads on the active backend until validated cutover
date: 2026-06-15
category: docs/solutions/architecture-patterns
module: ThinkWork Brain / Context Engine
...
# ThinkWork Brain migrations keep reads on the active backend until validated cutover

## Context

THNK-6 finished the ThinkWork Brain parent-scope substrate work after the initial
...
This closes a gap that product docs and runbooks only imply: ThinkWork Brain can
offer a production storage tier without teaching agents, tenant callers, or UI
status payloads about raw the retired graph substrate, Neptune, S3, or EFS implementation details.
...
the retired graph substrate endpoints, S3 roots, Neptune ids/endpoints, EFS ids, and deployment job
...
while agents continue reading the last known safe ThinkWork Brain route.
...
Good ThinkWork Brain migration shape:
...
- [THNK-6 remaining substrate plan](../../plans/2026-06-14-004-feat-brain-remaining-substrate-plan.md)
- [PR #2461: add ThinkWork Brain migration orchestration](https://github.com/thinkwork-ai/thinkwork/pull/2461)
- [PR #2462: make ThinkWork Brain reads migration-aware](https://github.com/thinkwork-ai/thinkwork/pull/2462)
- [PR #2464: add ThinkWork Brain operations surface](https://github.com/thinkwork-ai/thinkwork/pull/2464)
- [PR #2465: add ThinkWork Brain smoke closure](https://github.com/thinkwork-ai/thinkwork/pull/2465)
