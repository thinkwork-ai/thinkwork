---
title: ThinkWork Brain active-substrate reads stay behind Context Engine
date: 2026-06-15
...
# ThinkWork Brain active-substrate reads stay behind Context Engine

## Context

THNK-20 delivered the first ThinkWork Brain dogfood proof: a first-party path can
...
ThinkWork Brain retrieval can become real without exposing the retired graph substrate, Neptune, S3,
...
```text
ThinkWork Brain capability disabled: retrieval
hits: []
...
the retired graph substrate, Neptune, or S3 paths.
...
metadata: {
  retrievalKind: "graph",
  retrievalSurface: "brain_active_backend",
...
ThinkWork Brain sits at a trust boundary: it is tenant-shared business context,
...
The source-data boundary is equally important. ThinkWork Brain content may include
...
```text
query_brain_context
  -> raw the retired graph substrate/Neptune/S3 tool
...
- [PR #2455: route ThinkWork Brain reads through Context Engine](https://github.com/thinkwork-ai/thinkwork/pull/2455)
...
- [the retired graph substrate Thread Ingest Explorer validation pattern](../best-practices/retired_graph_substrate-thread-ingest-explorer-2026-06-04.md)
